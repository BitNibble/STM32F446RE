...
{
	return get_reg_block(ADC1->SR, 1, 5);
}
void STM32446ADC1_sr_clear_ovr(void)
{
	set_reg_block(&ADC1->SR, 1, 5, 0);
}
uint8_t STM32446ADC1_sr_strt(void)
{
	return get_reg_block(ADC1->SR, 1, 4);
}
void STM32446ADC1_sr_clear_strt(void)
{
	set_reg_block(&ADC1->SR, 1, 4, 0);
}
uint8_t STM32446ADC1_sr_jstrt(void)
{
	return get_reg_block(ADC1->SR, 1, 3);
}
void STM32446ADC1_sr_clear_jstrt(void)
{
	set_reg_block(&ADC1->SR, 1, 3, 0);
}
uint8_t STM32446ADC1_sr_jeoc(void)
{
	return get_reg_block(ADC1->SR, 1, 2);
}
void STM32446ADC1_sr_clear_jeoc(void)
{
	set_reg_block(&ADC1->SR, 1, 2, 0);
}
uint8_t STM32446ADC1_sr_eoc(void)
{
	return get_reg_block(ADC1->SR, 1, 1);
}
void STM32446ADC1_sr_clear_eoc(void)
{
	set_reg_block(&ADC1->SR, 1, 1, 0);
}
uint8_t STM32446ADC1_sr_awd(void)
{
	return get_reg_block(ADC1->SR, 1, 0);
}
void STM32446ADC1_sr_clear_awd(void)
{
	set_reg_block(&ADC1->SR, 1, 0, 0);
}
// CR1
void STM32446ADC1_cr1_ovrie(uint8_t state)
{
	set_reg_block(&ADC1->CR1, 1, 26, state);
}
void STM32446ADC1_cr1_res(uint8_t value)
{
	set_reg_block(&ADC1->CR1, 2, 24, value);
}
void STM32446ADC1_cr1_awden(uint8_t state)
{
	set_reg_block(&ADC1->CR1, 1, 23, state);
}
void STM32446ADC1_cr1_jawden(uint8_t state)
{
	set_reg_block(&ADC1->CR1, 1, 22, state);
}
void STM32446ADC1_cr1_discnum(uint8_t value)
{
	set_reg_block(&ADC1->CR1, 3, 13, value);
}
void STM32446ADC1_cr1_jdiscen(uint8_t state)
{
	set_reg_block(&ADC1->CR1, 1, 12, state);
}
void STM32446ADC1_cr1_discen(uint8_t state)
{
	set_reg_block(&ADC1->CR1, 1, 11, state);
}
void STM32446ADC1_cr1_jauto(uint8_t state)
{
	set_reg_block(&ADC1->CR1, 1, 10, state);
}
void STM32446ADC1_cr1_awdsgl(uint8_t state)
{
	set_reg_block(&ADC1->CR1, 1, 9, state);
}
void STM32446ADC1_cr1_scan(uint8_t state)
{
	set_reg_block(&ADC1->CR1, 1, 8, state);
}
void STM32446ADC1_cr1_jeocie(uint8_t state)
{
	set_reg_block(&ADC1->CR1, 1, 7, state);
}
void STM32446ADC1_cr1_awdie(uint8_t state)
{
	set_reg_block(&ADC1->CR1, 1, 6, state);
}
void STM32446ADC1_cr1_eocie(uint8_t state)
{
	set_reg_block(&ADC1->CR1, 1, 5, state);
}
void STM32446ADC1_cr1_awdch(uint8_t value)
{
	set_reg_block(&ADC1->CR1, 5, 0, value);
}
// CR2
void STM32446ADC1_cr2_swstart(uint8_t state)
{
	set_reg_block(&ADC1->CR2, 1, 30, state);
}
uint8_t STM32446ADC1_cr2_read_swstart(void)
{
	return get_reg_block(ADC1->CR2, 1, 30);
}
void STM32446ADC1_cr2_exten(uint8_t value)
{
	set_reg_block(&ADC1->CR2, 2, 28, value);
}
void STM32446ADC1_cr2_extsel(uint8_t value)
{
	set_reg_block(&ADC1->CR2, 4, 24, value);
}
void STM32446ADC1_cr2_jswstart(uint8_t state)
{
	set_reg_block(&ADC1->CR2, 1, 22, state);
}
void STM32446ADC1_cr2_jexten(uint8_t value)
{
	set_reg_block(&ADC1->CR2, 2, 20, value);
}
void STM32446ADC1_cr2_jextsel(uint8_t value)
{
	set_reg_block(&ADC1->CR2, 4, 16, value);
}
void STM32446ADC1_cr2_align(uint8_t state)
{
	set_reg_block(&ADC1->CR2, 1, 11, state);
}
void STM32446ADC1_cr2_eocs(uint8_t state)
{
	set_reg_block(&ADC1->CR2, 1, 10, state);
}
void STM32446ADC1_cr2_dds(uint8_t state)
{
	set_reg_block(&ADC1->CR2, 1, 9, state);
}
void STM32446ADC1_cr2_dma(uint8_t state)
{
	set_reg_block(&ADC1->CR2, 1, 8, state);
}
void STM32446ADC1_cr2_cont(uint8_t state)
{
	set_reg_block(&ADC1->CR2, 1, 1, state);
}
void STM32446ADC1_cr2_adon(uint8_t state)
{
	set_reg_block(&ADC1->CR2, 1, 0, state);
}
// SMPR1
void STM32446ADC1_smpr1_smp18(uint8_t value)
{
	set_reg_block(&ADC1->SMPR1, 3, 24, value);
}
void STM32446ADC1_smpr1_smp17(uint8_t value)
{
	set_reg_block(&ADC1->SMPR1, 3, 21, value);
}
void STM32446ADC1_smpr1_smp16(uint8_t value)
{
	set_reg_block(&ADC1->SMPR1, 3, 18, value);
}
void STM32446ADC1_smpr1_smp15(uint8_t value)
{
	set_reg_block(&ADC1->SMPR1, 3, 15, value);
}
void STM32446ADC1_smpr1_smp14(uint8_t value)
{
	set_reg_block(&ADC1->SMPR1, 3, 12, value);
}
void STM32446ADC1_smpr1_smp13(uint8_t value)
{
	set_reg_block(&ADC1->SMPR1, 3, 9, value);
}
void STM32446ADC1_smpr1_smp12(uint8_t value)
{
	set_reg_block(&ADC1->SMPR1, 3, 6, value);
}
void STM32446ADC1_smpr1_smp11(uint8_t value)
{
	set_reg_block(&ADC1->SMPR1, 3, 3, value);
}
void STM32446ADC1_smpr1_smp10(uint8_t value)
{
	set_reg_block(&ADC1->SMPR1, 3, 0, value);
}
// SMPR2
void STM32446ADC1_smpr2_smp9(uint8_t value)
{
	set_reg_block(&ADC1->SMPR2, 3, 27, value);
}
void STM32446ADC1_smpr2_smp8(uint8_t value)
{
	set_reg_block(&ADC1->SMPR2, 3, 24, value);
}
void STM32446ADC1_smpr2_smp7(uint8_t value)
{
	set_reg_block(&ADC1->SMPR2, 3, 21, value);
}
void STM32446ADC1_smpr2_smp6(uint8_t value)
{
	set_reg_block(&ADC1->SMPR2, 3, 18, value);
}
void STM32446ADC1_smpr2_smp5(uint8_t state)
{
	set_reg_block(&ADC1->SMPR2, 3, 15, state);
}
void STM32446ADC1_smpr2_smp4(uint8_t value)
{
	set_reg_block(&ADC1->SMPR2, 3, 12, value);
}
void STM32446ADC1_smpr2_smp3(uint8_t value)
{
	set_reg_block(&ADC1->SMPR2, 3, 9, value);
}
void STM32446ADC1_smpr2_smp2(uint8_t value)
{
	set_reg_block(&ADC1->SMPR2, 3, 6, value);
}
void STM32446ADC1_smpr2_smp1(uint8_t value)
{
	set_reg_block(&ADC1->SMPR2, 3, 3, value);
}
void STM32446ADC1_smpr2_smp0(uint8_t value)
{
	set_reg_block(&ADC1->SMPR2, 3, 0, value);
}
void STM32446ADC1_jofr1(uint16_t value)
{
	set_reg_block(&ADC1->JOFR1, 12, 0, value);
}
void STM32446ADC1_jofr2(uint16_t value)
{
	set_reg_block(&ADC1->JOFR2, 12, 0, value);
}
void STM32446ADC1_jofr3(uint16_t value)
{
	set_reg_block(&ADC1->JOFR3, 12, 0, value);
}
void STM32446ADC1_jofr4(uint16_t value)
{
	set_reg_block(&ADC1->JOFR4, 12, 0, value);
}
void STM32446ADC1_htr(uint16_t value)
{
	set_reg_block(&ADC1->HTR, 12, 0, value);
}
void STM32446ADC1_ltr(uint16_t value)
{
	set_reg_block(&ADC1->LTR, 12, 0, value);
}
// SQR1
void STM32446ADC1_sqr1_l(uint8_t value)
{
	set_reg_block(&ADC1->SQR1, 4, 20, value);
}
void STM32446ADC1_sqr1_sq16(uint8_t value)
{
	set_reg_block(&ADC1->SQR1, 5, 15, value);
}
void STM32446ADC1_sqr1_sq15(uint8_t value)
{
	set_reg_block(&ADC1->SQR1, 5, 10, value);
}
void STM32446ADC1_sqr1_sq14(uint8_t value)
{
	set_reg_block(&ADC1->SQR1, 5, 5, value);
}
void STM32446ADC1_sqr1_sq13(uint8_t value)
{
	set_reg_block(&ADC1->SQR1, 5, 0, value);
}
// SQR2
void STM32446ADC1_sqr2_sq12(uint8_t value)
{
	set_reg_block(&ADC1->SQR2, 5, 25, value);
}
void STM32446ADC1_sqr2_sq11(uint8_t value)
{
	set_reg_block(&ADC1->SQR2, 5, 20, value);
}
void STM32446ADC1_sqr2_sq10(uint8_t value)
{
	set_reg_block(&ADC1->SQR2, 5, 15, value);
}
void STM32446ADC1_sqr2_sq9(uint8_t value)
{
	set_reg_block(&ADC1->SQR2, 5, 10, value);
}
void STM32446ADC1_sqr2_sq8(uint8_t value)
{
	set_reg_block(&ADC1->SQR2, 5, 5, value);
}
void STM32446ADC1_sqr2_sq7(uint8_t value)
{
	set_reg_block(&ADC1->SQR2, 5, 0, value);
}
// SQR3
void STM32446ADC1_sqr3_sq6(uint8_t value)
{
	set_reg_block(&ADC1->SQR3, 5, 25, value);
}
void STM32446ADC1_sqr3_sq5(uint8_t value)
{
	set_reg_block(&ADC1->SQR3, 5, 20, value);
}
void STM32446ADC1_sqr3_sq4(uint8_t value)
{
	set_reg_block(&ADC1->SQR3, 5, 15, value);
}
void STM32446ADC1_sqr3_sq3(uint8_t value)
{
	set_reg_block(&ADC1->SQR3, 5, 10, value);
}
void STM32446ADC1_sqr3_sq2(uint8_t value)
{
	set_reg_block(&ADC1->SQR3, 5, 5, value);
}
void STM32446ADC1_sqr3_sq1(uint8_t value)
{
	set_reg_block(&ADC1->SQR3, 5, 0, value);
}
// JSQR
void STM32446ADC1_jsqr_jl(uint8_t value)
{
	set_reg_block(&ADC1->JSQR, 2, 20, value);
}
void STM32446ADC1_jsqr_jsq4(uint8_t value)
{
	set_reg_block(&ADC1->JSQR, 5, 15, value);
}
void STM32446ADC1_jsqr_jsq3(uint8_t value)
{
	set_reg_block(&ADC1->JSQR, 5, 10, value);
}
void STM32446ADC1_jsqr_jsq2(uint8_t value)
{
	set_reg_block(&ADC1->JSQR, 5, 5, value);
}
void STM32446ADC1_jsqr_jsq1(uint8_t value)
{
	set_reg_block(&ADC1->JSQR, 5, 0, value);
}
uint16_t STM32446ADC1_jdr1(void)
{
	return get_reg_block(ADC1->JDR1, 16, 0);
}
uint16_t STM32446ADC1_jdr2(void)
{
	return get_reg_block(ADC1->JDR2, 16, 0);
}
uint16_t STM32446ADC1_jdr3(void)
{
	return get_reg_block(ADC1->JDR3, 16, 0);
}
uint16_t STM32446ADC1_jdr4(void)
{
	return get_reg_block(ADC1->JDR4, 16, 0);
}
uint16_t STM32446ADC1_dr(void)
{
	return get_reg_block(ADC1->DR, 16, 0);
}
/*** ADC1 Auxiliar ***/
STM32446ADC_SR* stm32446_adc1_sr_inic(void)
{
...
/*** ADC1 ***/
void STM32446Adc1IClock(uint8_t state)
{
	if(state){ RCC->APB1ENR |= (1 << 29); }else{ RCC->APB1ENR &= ~(1 << 29); }
}
void STM32446Adc1Clock(uint8_t state)
{
	if(state){ RCC->APB2ENR |= (1 << 8); }else{ RCC->APB2ENR &= ~(1 << 8); }
}
void STM32446Adc1Nvic(uint8_t state)
{
