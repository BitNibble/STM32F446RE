...
{
	return get_reg_block(ADC->CSR, 1, 21);
}
uint8_t STM32446ADC_csr_strt3(void)
{
	return get_reg_block(ADC->CSR, 1, 20);
}
uint8_t STM32446ADC_csr_jstrt3(void)
{
	return get_reg_block(ADC->CSR, 1, 19);
}
uint8_t STM32446ADC_csr_jeoc3(void)
{
	return get_reg_block(ADC->CSR, 1, 18);
}
uint8_t STM32446ADC_csr_eoc3(void)
{
	return get_reg_block(ADC->CSR, 1, 17);
}
uint8_t STM32446ADC_csr_awd3(void)
{
	return get_reg_block(ADC->CSR, 1, 16);
}
uint8_t STM32446ADC_csr_ovr2(void)
{
	return get_reg_block(ADC->CSR, 1, 13);
}
uint8_t STM32446ADC_csr_strt2(void)
{
	return get_reg_block(ADC->CSR, 1, 12);
}
uint8_t STM32446ADC_csr_jstrt2(void)
{
	return get_reg_block(ADC->CSR, 1, 11);
}
uint8_t STM32446ADC_csr_jeoc2(void)
{
	return get_reg_block(ADC->CSR, 1, 10);
}
uint8_t STM32446ADC_csr_eoc2(void)
{
	return get_reg_block(ADC->CSR, 1, 9);
}
uint8_t STM32446ADC_csr_awd2(void)
{
	return get_reg_block(ADC->CSR, 1, 8);
}
uint8_t STM32446ADC_csr_ovr1(void)
{
	return get_reg_block(ADC->CSR, 1, 5);
}
uint8_t STM32446ADC_csr_strt1(void)
{
	return get_reg_block(ADC->CSR, 1, 4);
}
uint8_t STM32446ADC_csr_jstrt1(void)
{
	return get_reg_block(ADC->CSR, 1, 3);
}
uint8_t STM32446ADC_csr_jeoc1(void)
{
	return get_reg_block(ADC->CSR, 1, 2);
}
uint8_t STM32446ADC_csr_eoc1(void)
{
	return get_reg_block(ADC->CSR, 1, 1);
}
uint8_t STM32446ADC_csr_awd1(void)
{
	return get_reg_block(ADC->CSR, 1, 0);
}
// CCR
void STM32446ADC_ccr_tsvrefe(uint8_t state)
{
	set_reg_block(&ADC->CCR, 1, 23, state);
}
void STM32446ADC_ccr_vbate(uint8_t state)
{
	set_reg_block(&ADC->CCR, 2, 22, state);
}
void STM32446ADC_ccr_adcpre(uint8_t value)
{
	set_reg_block(&ADC->CCR, 2, 16, value);
}
void STM32446ADC_ccr_dma(uint8_t value)
{
	set_reg_block(&ADC->CCR, 2, 14, value);
}
void STM32446ADC_ccr_dds(uint8_t state)
{
	set_reg_block(&ADC->CCR, 1, 13, state);
}
void STM32446ADC_ccr_delay(uint8_t value)
{
	set_reg_block(&ADC->CCR, 4, 8, value);
}
void STM32446ADC_ccr_multi(uint8_t value)
{
	set_reg_block(&ADC->CCR, 5, 0, value);
}
// CDR
