...
/*** TIM1 ***/
/************/
void STM32446Tim1Clock(uint8_t state)
{
...
{
	set_reg_block(&TIM1->CR1, 1, 8, value);
}
uint8_t STM32446Tim1_get_ckd(void)
{
	return get_reg_block(TIM1->CR1, 2, 8);
}
void STM32446Tim1_set_apre(uint8_t state)
{
	set_reg_block(&TIM1->CR1, 1, 7, state);
}
void STM32446Tim1_set_cms(uint8_t value)
{
	set_reg_block(&TIM1->CR1, 2, 5, value);
}
void STM32446Tim1_set_dir(uint8_t state)
{
	set_reg_block(&TIM1->CR1, 1, 4, state);
}
void STM32446Tim1_set_opm(uint8_t state)
{
	set_reg_block(&TIM1->CR1, 1, 3, state);
}
void STM32446Tim1_set_urs(uint8_t state)
{
	set_reg_block(&TIM1->CR1, 1, 2, state);
}
void STM32446Tim1_set_udis(uint8_t state)
{
	set_reg_block(&TIM1->CR1, 1, 1, state);
}
void STM32446Tim1_cen(uint8_t state)
{
	set_reg_block(&TIM1->CR1, 1, 0, state);
}
// CR2
void STM32446Tim1_ois4(uint8_t state)
{
	set_reg_block(&TIM1->CR2, 1, 14, state);
}
void STM32446Tim1_ois3n(uint8_t state)
{
	set_reg_block(&TIM1->CR2, 1, 13, state);
}
void STM32446Tim1_ois3(uint8_t state)
{
	set_reg_block(&TIM1->CR2, 1, 12, state);
}
void STM32446Tim1_ois2n(uint8_t state)
{
	set_reg_block(&TIM1->CR2, 1, 11, state);
}
void STM32446Tim1_ois2(uint8_t state)
{
	set_reg_block(&TIM1->CR2, 1, 10, state);
}
void STM32446Tim1_ois1n(uint8_t state)
{
	set_reg_block(&TIM1->CR2, 1, 9, state);
}
void STM32446Tim1_ois1(uint8_t state)
{
	set_reg_block(&TIM1->CR2, 1, 8, state);
}
void STM32446Tim1_ti1s(uint8_t state)
{
	set_reg_block(&TIM1->CR2, 1, 7, state);
}
void STM32446Tim1_mms(uint8_t value)
{
	set_reg_block(&TIM1->CR2, 3, 4, value);
}
void STM32446Tim1_ccds(uint8_t state)
{
	set_reg_block(&TIM1->CR2, 1, 3, state);
}
void STM32446Tim1_ccus(uint8_t state)
{
	set_reg_block(&TIM1->CR2, 1, 2, state);
}
void STM32446Tim1_ccpc(uint8_t state)
{
	set_reg_block(&TIM1->CR2, 1, 0, state);
}
// SMCR
void STM32446Tim1_etp(uint8_t state)
{
	set_reg_block(&TIM1->SMCR, 1, 15, state);
}
void STM32446Tim1_ece(uint8_t state)
{
	set_reg_block(&TIM1->SMCR, 1, 14, state);
}
void STM32446Tim1_etps(uint8_t value)
{
	set_reg_block(&TIM1->SMCR, 2, 12, value);
}
void STM32446Tim1_etf(uint8_t value)
{
	set_reg_block(&TIM1->SMCR, 4, 8, value);
}
void STM32446Tim1_msm(uint8_t state)
{
	set_reg_block(&TIM1->SMCR, 1, 7, state);
}
void STM32446Tim1_ts(uint8_t value)
{
	set_reg_block(&TIM1->SMCR, 3, 4, value);
}
void STM32446Tim1_sms(uint8_t value)
{
	set_reg_block(&TIM1->SMCR, 3, 0, value);
}
// DIER
void STM32446Tim1_tde(uint8_t state)
{
	set_reg_block(&TIM1->DIER, 1, 14, state);
}
void STM32446Tim1_comde(uint8_t state)
{
	set_reg_block(&TIM1->DIER, 1, 14, state);
}
void STM32446Tim1_cc4de(uint8_t state)
{
	set_reg_block(&TIM1->DIER, 1, 12, state);
}
void STM32446Tim1_cc3de(uint8_t state)
{
	set_reg_block(&TIM1->DIER, 1, 11, state);
}
void STM32446Tim1_cc2de(uint8_t state)
{
	set_reg_block(&TIM1->DIER, 1, 10, state);
}
void STM32446Tim1_cc1de(uint8_t state)
{
	set_reg_block(&TIM1->DIER, 1, 9, state);
}
void STM32446Tim1_ude(uint8_t state)
{
	set_reg_block(&TIM1->DIER, 1, 8, state);
}
void STM32446Tim1_bie(uint8_t state)
{
	set_reg_block(&TIM1->DIER, 1, 7, state);
}
void STM32446Tim1_tie(uint8_t state)
{
	set_reg_block(&TIM1->DIER, 1, 6, state);
}
void STM32446Tim1_comie(uint8_t state)
{
	set_reg_block(&TIM1->DIER, 1, 5, state);
}
void STM32446Tim1_cc4ie(uint8_t state)
{
	set_reg_block(&TIM1->DIER, 1, 4, state);
}
void STM32446Tim1_cc3ie(uint8_t state)
{
	set_reg_block(&TIM1->DIER, 1, 3, state);
}
void STM32446Tim1_cc2ie(uint8_t state)
{
	set_reg_block(&TIM1->DIER, 1, 2, state);
}
void STM32446Tim1_cc1ie(uint8_t state)
{
	set_reg_block(&TIM1->DIER, 1, 1, state);
}
void STM32446Tim1_uie(uint8_t state)
{
	set_reg_block(&TIM1->DIER, 1, 0, state);
}
// SR
uint8_t STM32446Tim1_cc4of(void)
{
	return get_reg_block(TIM1->SR, 1, 12);
}
void STM32446Tim1_clear_cc4of(void)
{
	set_reg_block(&TIM1->SR, 1, 12, 0);
}
uint8_t STM32446Tim1_cc3of(void)
{
	return get_reg_block(TIM1->SR, 1, 11);
}
void STM32446Tim1_clear_cc3of(void)
{
	set_reg_block(&TIM1->SR, 1, 11, 0);
}
uint8_t STM32446Tim1_cc2of(void)
{
	return get_reg_block(TIM1->SR, 1, 10);
}
void STM32446Tim1_clear_cc2of(void)
{
	set_reg_block(&TIM1->SR, 1, 10, 0);
}
uint8_t STM32446Tim1_cc1of(void)
{
	return get_reg_block(TIM1->SR, 1, 9);
}
void STM32446Tim1_clear_cc1of(void)
{
	set_reg_block(&TIM1->SR, 1, 9, 0);
}
uint8_t STM32446Tim1_bif(void)
{
	return get_reg_block(TIM1->SR, 1, 7);
}
void STM32446Tim1_clear_bif(void)
{
	set_reg_block(&TIM1->SR, 1, 7, 0);
}
uint8_t STM32446Tim1_tif(void)
{
	return get_reg_block(TIM1->SR, 1, 6);
}
void STM32446Tim1_clear_tif(void)
{
	set_reg_block(&TIM1->SR, 1, 6, 0);
}
uint8_t STM32446Tim1_comif(void)
{
	return get_reg_block(TIM1->SR, 1, 5);
}
void STM32446Tim1_clear_comif(void)
{
	set_reg_block(&TIM1->SR, 1, 5, 0);
}
uint8_t STM32446Tim1_cc4if(void)
{
	return get_reg_block(TIM1->SR, 1, 4);
}
void STM32446Tim1_clear_cc4if(void)
{
	set_reg_block(&TIM1->SR, 1, 4, 0);
}
uint8_t STM32446Tim1_cc3if(void)
{
	return get_reg_block(TIM1->SR, 1, 3);
}
void STM32446Tim1_clear_cc3if(void)
{
	set_reg_block(&TIM1->SR, 1, 3, 0);
}
uint8_t STM32446Tim1_cc2if(void)
{
	return get_reg_block(TIM1->SR, 1, 2);
}
void STM32446Tim1_clear_cc2if(void)
{
	set_reg_block(&TIM1->SR, 1, 2, 0);
}
uint8_t STM32446Tim1_cc1if(void)
{
	return get_reg_block(TIM1->SR, 1, 1);
}
void STM32446Tim1_clear_cc1if(void)
{
	set_reg_block(&TIM1->SR, 1, 1, 0);
}
uint8_t STM32446Tim1_uif(void)
{
	return get_reg_block(TIM1->SR, 1, 0);
}
void STM32446Tim1_clear_uif(void)
{
	set_reg_block(&TIM1->SR, 1, 0, 0);
}
// EGR
void STM32446Tim1_bg(void)
{
	set_reg_block(&TIM1->EGR, 1, 7, 1);
}
void STM32446Tim1_tg(void)
{
	set_reg_block(&TIM1->EGR, 1, 6, 1);
}
void STM32446Tim1_comg(void)
{
	set_reg_block(&TIM1->EGR, 1, 5, 1);
}
void STM32446Tim1_cc4g(void)
{
	set_reg_block(&TIM1->EGR, 1, 4, 1);
}
void STM32446Tim1_cc3g(void)
{
	set_reg_block(&TIM1->EGR, 1, 3, 1);
}
void STM32446Tim1_cc2g(void)
{
	set_reg_block(&TIM1->EGR, 1, 2, 1);
}
void STM32446Tim1_cc1g(void)
{
	set_reg_block(&TIM1->EGR, 1, 1, 1);
}
void STM32446Tim1_ug(void)
{
	set_reg_block(&TIM1->EGR, 1, 0, 1);
}
// CCMR1
void STM32446Tim1_oc2ce(uint8_t value)
{
	set_reg_block(&TIM1->CCMR1, 1, 15, value);
}
void STM32446Tim1_oc2m(uint8_t value)
{
	set_reg_block(&TIM1->CCMR1, 3, 12, value);
}
void STM32446Tim1_ic2f(uint8_t value)
{
	set_reg_block(&TIM1->CCMR1, 4, 12, value);
}
void STM32446Tim1_oc2pe(uint8_t state)
{
	set_reg_block(&TIM1->CCMR1, 1, 11, state);
}
void STM32446Tim1_oc2fe(uint8_t state)
{
	set_reg_block(&TIM1->CCMR1, 1, 10, state);
}
void STM32446Tim1_ic2psc(uint8_t value)
{
	set_reg_block(&TIM1->CCMR1, 2, 10, value);
}
void STM32446Tim1_cc2s(uint8_t value)
{
	set_reg_block(&TIM1->CCMR1, 2, 8, value);
}
void STM32446Tim1_oc1ce(uint8_t value)
{
	set_reg_block(&TIM1->CCMR1, 1, 7, value);
}
void STM32446Tim1_oc1m(uint8_t value)
{
	set_reg_block(&TIM1->CCMR1, 3, 4, value);
}
void STM32446Tim1_ic1f(uint8_t value)
{
	set_reg_block(&TIM1->CCMR1, 4, 4, value);
}
void STM32446Tim1_oc1pe(uint8_t state)
{
	set_reg_block(&TIM1->CCMR1, 1, 3, state);
}
void STM32446Tim1_oc1fe(uint8_t state)
{
	set_reg_block(&TIM1->CCMR1, 1, 2, state);
}
void STM32446Tim1_ic1psc(uint8_t value)
{
	set_reg_block(&TIM1->CCMR1, 2, 2, value);
}
void STM32446Tim1_cc1s(uint8_t value)
{
	set_reg_block(&TIM1->CCMR1, 2, 0, value);
}
// CCMR2
void STM32446Tim1_oc4ce(uint8_t value)
{
	set_reg_block(&TIM1->CCMR2, 1, 15, value);
}
void STM32446Tim1_oc4m(uint8_t value)
{
	set_reg_block(&TIM1->CCMR2, 3, 12, value);
}
void STM32446Tim1_ic4f(uint8_t value)
{
	set_reg_block(&TIM1->CCMR2, 4, 12, value);
}
void STM32446Tim1_oc4pe(uint8_t state)
{
	set_reg_block(&TIM1->CCMR2, 1, 11, state);
}
void STM32446Tim1_oc4fe(uint8_t state)
{
	set_reg_block(&TIM1->CCMR2, 1, 10, state);
}
void STM32446Tim1_ic4psc(uint8_t value)
{
	set_reg_block(&TIM1->CCMR2, 2, 10, value);
}
void STM32446Tim1_cc4s(uint8_t value)
{
	set_reg_block(&TIM1->CCMR2, 2, 8, value);
}
void STM32446Tim1_oc3ce(uint8_t value)
{
	set_reg_block(&TIM1->CCMR2, 1, 7, value);
}
void STM32446Tim1_oc3m(uint8_t value)
{
	set_reg_block(&TIM1->CCMR2, 3, 4, value);
}
void STM32446Tim1_ic3f(uint8_t value)
{
	set_reg_block(&TIM1->CCMR2, 4, 4, value);
}
void STM32446Tim1_oc3pe(uint8_t state)
{
	set_reg_block(&TIM1->CCMR2, 1, 3, state);
}
void STM32446Tim1_oc3fe(uint8_t state)
{
	set_reg_block(&TIM1->CCMR2, 1, 2, state);
}
void STM32446Tim1_ic3psc(uint8_t value)
{
	set_reg_block(&TIM1->CCMR2, 2, 2, value);
}
void STM32446Tim1_cc3s(uint8_t value)
{
	set_reg_block(&TIM1->CCMR2, 2, 0, value);
}
// CCER
void STM32446Tim1_cc4np(uint8_t state)
{
	set_reg_block(&TIM1->CCER, 1, 15, state);
}
void STM32446Tim1_cc4p(uint8_t state)
{
	set_reg_block(&TIM1->CCER, 1, 13, state);
}
void STM32446Tim1_cc4e(uint8_t state)
{
	set_reg_block(&TIM1->CCER, 1, 12, state);
}
void STM32446Tim1_cc3np(uint8_t state)
{
	set_reg_block(&TIM1->CCER, 1, 11, state);
}
void STM32446Tim1_cc3ne(uint8_t state)
{
	set_reg_block(&TIM1->CCER, 1, 11, state);
}
void STM32446Tim1_cc3p(uint8_t state)
{
	set_reg_block(&TIM1->CCER, 1, 9, state);
}
void STM32446Tim1_cc3e(uint8_t state)
{
	set_reg_block(&TIM1->CCER, 1, 8, state);
}
void STM32446Tim1_cc2np(uint8_t state)
{
	set_reg_block(&TIM1->CCER, 1, 7, state);
}
void STM32446Tim1_cc2ne(uint8_t state)
{
	set_reg_block(&TIM1->CCER, 1, 6, state);
}
void STM32446Tim1_cc2p(uint8_t state)
{
	set_reg_block(&TIM1->CCER, 1, 5, state);
}
void STM32446Tim1_cc2e(uint8_t state)
{
	set_reg_block(&TIM1->CCER, 1, 4, state);
}
void STM32446Tim1_cc1np(uint8_t state)
{
	set_reg_block(&TIM1->CCER, 1, 3, state);
}
void STM32446Tim1_cc1ne(uint8_t state)
{
	set_reg_block(&TIM1->CCER, 1, 2, state);
}
void STM32446Tim1_cc1p(uint8_t state)
{
	set_reg_block(&TIM1->CCER, 1, 1, state);
}
void STM32446Tim1_cc1e(uint8_t state)
{
	set_reg_block(&TIM1->CCER, 1, 0, state);
}
// CNT
...
// BDTR
void STM32446Tim1_moe(uint8_t state)
{
	set_reg_block(&TIM1->BDTR, 1, 15, state);
}
void STM32446Tim1_aoe(uint8_t state)
{
	set_reg_block(&TIM1->BDTR, 1, 14, state);
}
void STM32446Tim1_bkp(uint8_t state)
{
	set_reg_block(&TIM1->BDTR, 1, 13, state);
}
void STM32446Tim1_bke(uint8_t state)
{
	set_reg_block(&TIM1->BDTR, 1, 12, state);
}
void STM32446Tim1_ossr(uint8_t state)
{
	set_reg_block(&TIM1->BDTR, 1, 11, state);
}
void STM32446Tim1_ossi(uint8_t state)
{
	set_reg_block(&TIM1->BDTR, 1, 10, state);
}
void STM32446Tim1_lock(uint8_t value)
{
	set_reg_block(&TIM1->BDTR, 2, 8, value);
}
void STM32446Tim1_dtg(uint8_t value)
{
	set_reg_block(&TIM1->BDTR, 8, 0, value);
}
// DCR
void STM32446Tim1_dbl(uint8_t value)
{
	set_reg_block(&TIM1->DCR, 5, 8, value);
}
void STM32446Tim1_dba(uint8_t value)
{
	set_reg_block(&TIM1->DCR, 5, 0, value);
}
// DMAR
...
/*** TIM8 ***/
/************/
void STM32446Tim8Clock(uint8_t state)
{
...
{
	set_reg_block(&TIM8->CR1, 1, 8, value);
}
uint8_t STM32446Tim8_get_ckd(void)
{
	return get_reg_block(TIM8->CR1, 2, 8);
}
void STM32446Tim8_set_apre(uint8_t state)
{
	set_reg_block(&TIM8->CR1, 1, 7, state);
}
void STM32446Tim8_set_cms(uint8_t value)
{
	set_reg_block(&TIM8->CR1, 2, 5, value);
}
void STM32446Tim8_set_dir(uint8_t state)
{
	set_reg_block(&TIM8->CR1, 1, 4, state);
}
void STM32446Tim8_set_opm(uint8_t state)
{
	set_reg_block(&TIM8->CR1, 1, 3, state);
}
void STM32446Tim8_set_urs(uint8_t state)
{
	set_reg_block(&TIM8->CR1, 1, 2, state);
}
void STM32446Tim8_set_udis(uint8_t state)
{
	set_reg_block(&TIM8->CR1, 1, 1, state);
}
void STM32446Tim8_cen(uint8_t state)
{
	set_reg_block(&TIM8->CR1, 1, 0, state);
}
// CR2
void STM32446Tim8_ois4(uint8_t state)
{
	set_reg_block(&TIM8->CR2, 1, 14, state);
}
void STM32446Tim8_ois3n(uint8_t state)
{
	set_reg_block(&TIM8->CR2, 1, 13, state);
}
void STM32446Tim8_ois3(uint8_t state)
{
	set_reg_block(&TIM8->CR2, 1, 12, state);
}
void STM32446Tim8_ois2n(uint8_t state)
{
	set_reg_block(&TIM8->CR2, 1, 11, state);
}
void STM32446Tim8_ois2(uint8_t state)
{
	set_reg_block(&TIM8->CR2, 1, 10, state);
}
void STM32446Tim8_ois1n(uint8_t state)
{
	set_reg_block(&TIM8->CR2, 1, 9, state);
}
void STM32446Tim8_ois1(uint8_t state)
{
	set_reg_block(&TIM8->CR2, 1, 8, state);
}
void STM32446Tim8_ti1s(uint8_t state)
{
	set_reg_block(&TIM8->CR2, 1, 7, state);
}
void STM32446Tim8_mms(uint8_t value)
{
	set_reg_block(&TIM8->CR2, 3, 4, value);
}
void STM32446Tim8_ccds(uint8_t state)
{
	set_reg_block(&TIM8->CR2, 1, 3, state);
}
void STM32446Tim8_ccus(uint8_t state)
{
	set_reg_block(&TIM8->CR2, 1, 2, state);
}
void STM32446Tim8_ccpc(uint8_t state)
{
	set_reg_block(&TIM8->CR2, 1, 0, state);
}
// SMCR
void STM32446Tim8_etp(uint8_t state)
{
	set_reg_block(&TIM8->SMCR, 1, 15, state);
}
void STM32446Tim8_ece(uint8_t state)
{
	set_reg_block(&TIM8->SMCR, 1, 14, state);
}
void STM32446Tim8_etps(uint8_t value)
{
	set_reg_block(&TIM8->SMCR, 2, 12, value);
}
void STM32446Tim8_etf(uint8_t value)
{
	set_reg_block(&TIM8->SMCR, 4, 8, value);
}
void STM32446Tim8_msm(uint8_t state)
{
	set_reg_block(&TIM8->SMCR, 1, 7, state);
}
void STM32446Tim8_ts(uint8_t value)
{
	set_reg_block(&TIM8->SMCR, 3, 4, value);
}
void STM32446Tim8_sms(uint8_t value)
{
	set_reg_block(&TIM8->SMCR, 3, 0, value);
}
// DIER
void STM32446Tim8_tde(uint8_t state)
{
	set_reg_block(&TIM8->DIER, 1, 14, state);
}
void STM32446Tim8_comde(uint8_t state)
{
	set_reg_block(&TIM8->DIER, 1, 14, state);
}
void STM32446Tim8_cc4de(uint8_t state)
{
	set_reg_block(&TIM8->DIER, 1, 12, state);
}
void STM32446Tim8_cc3de(uint8_t state)
{
	set_reg_block(&TIM8->DIER, 1, 11, state);
}
void STM32446Tim8_cc2de(uint8_t state)
{
	set_reg_block(&TIM8->DIER, 1, 10, state);
}
void STM32446Tim8_cc1de(uint8_t state)
{
	set_reg_block(&TIM8->DIER, 1, 9, state);
}
void STM32446Tim8_ude(uint8_t state)
{
	set_reg_block(&TIM8->DIER, 1, 8, state);
}
void STM32446Tim8_bie(uint8_t state)
{
	set_reg_block(&TIM8->DIER, 1, 7, state);
}
void STM32446Tim8_tie(uint8_t state)
{
	set_reg_block(&TIM8->DIER, 1, 6, state);
}
void STM32446Tim8_comie(uint8_t state)
{
	set_reg_block(&TIM8->DIER, 1, 5, state);
}
void STM32446Tim8_cc4ie(uint8_t state)
{
	set_reg_block(&TIM8->DIER, 1, 4, state);
}
void STM32446Tim8_cc3ie(uint8_t state)
{
	set_reg_block(&TIM8->DIER, 1, 3, state);
}
void STM32446Tim8_cc2ie(uint8_t state)
{
	set_reg_block(&TIM8->DIER, 1, 2, state);
}
void STM32446Tim8_cc1ie(uint8_t state)
{
	set_reg_block(&TIM8->DIER, 1, 1, state);
}
void STM32446Tim8_uie(uint8_t state)
{
	set_reg_block(&TIM8->DIER, 1, 0, state);
}
// SR
uint8_t STM32446Tim8_cc4of(void)
{
	return get_reg_block(TIM8->SR, 1, 12);
}
void STM32446Tim8_clear_cc4of(void)
{
	set_reg_block(&TIM8->SR, 1, 12, 0);
}
uint8_t STM32446Tim8_cc3of(void)
{
	return get_reg_block(TIM8->SR, 1, 11);
}
void STM32446Tim8_clear_cc3of(void)
{
	set_reg_block(&TIM8->SR, 1, 11, 0);
}
uint8_t STM32446Tim8_cc2of(void)
{
	return get_reg_block(TIM8->SR, 1, 10);
}
void STM32446Tim8_clear_cc2of(void)
{
	set_reg_block(&TIM8->SR, 1, 10, 0);
}
uint8_t STM32446Tim8_cc1of(void)
{
	return get_reg_block(TIM8->SR, 1, 9);
}
void STM32446Tim8_clear_cc1of(void)
{
	set_reg_block(&TIM8->SR, 1, 9, 0);
}
uint8_t STM32446Tim8_bif(void)
{
	return get_reg_block(TIM8->SR, 1, 7);
}
void STM32446Tim8_clear_bif(void)
{
	set_reg_block(&TIM8->SR, 1, 7, 0);
}
uint8_t STM32446Tim8_tif(void)
{
	return get_reg_block(TIM8->SR, 1, 6);
}
void STM32446Tim8_clear_tif(void)
{
	set_reg_block(&TIM8->SR, 1, 6, 0);
}
uint8_t STM32446Tim8_comif(void)
{
	return get_reg_block(TIM8->SR, 1, 5);
}
void STM32446Tim8_clear_comif(void)
{
	set_reg_block(&TIM8->SR, 1, 5, 0);
}
uint8_t STM32446Tim8_cc4if(void)
{
	return get_reg_block(TIM8->SR, 1, 4);
}
void STM32446Tim8_clear_cc4if(void)
{
	set_reg_block(&TIM8->SR, 1, 4, 0);
}
uint8_t STM32446Tim8_cc3if(void)
{
	return get_reg_block(TIM8->SR, 1, 3);
}
void STM32446Tim8_clear_cc3if(void)
{
	set_reg_block(&TIM8->SR, 1, 3, 0);
}
uint8_t STM32446Tim8_cc2if(void)
{
	return get_reg_block(TIM8->SR, 1, 2);
}
void STM32446Tim8_clear_cc2if(void)
{
	set_reg_block(&TIM8->SR, 1, 2, 0);
}
uint8_t STM32446Tim8_cc1if(void)
{
	return get_reg_block(TIM8->SR, 1, 1);
}
void STM32446Tim8_clear_cc1if(void)
{
	set_reg_block(&TIM8->SR, 1, 1, 0);
}
uint8_t STM32446Tim8_uif(void)
{
	return get_reg_block(TIM8->SR, 1, 0);
}
void STM32446Tim8_clear_uif(void)
{
	set_reg_block(&TIM8->SR, 1, 0, 0);
}
// EGR
void STM32446Tim8_bg(void)
{
	set_reg_block(&TIM8->EGR, 1, 7, 1);
}
void STM32446Tim8_tg(void)
{
	set_reg_block(&TIM8->EGR, 1, 6, 1);
}
void STM32446Tim8_comg(void)
{
	set_reg_block(&TIM8->EGR, 1, 5, 1);
}
void STM32446Tim8_cc4g(void)
{
	set_reg_block(&TIM8->EGR, 1, 4, 1);
}
void STM32446Tim8_cc3g(void)
{
	set_reg_block(&TIM8->EGR, 1, 3, 1);
}
void STM32446Tim8_cc2g(void)
{
	set_reg_block(&TIM8->EGR, 1, 2, 1);
}
void STM32446Tim8_cc1g(void)
{
	set_reg_block(&TIM8->EGR, 1, 1, 1);
}
void STM32446Tim8_ug(void)
{
	set_reg_block(&TIM8->EGR, 1, 0, 1);
}
// CCMR1
void STM32446Tim8_oc2ce(uint8_t value)
{
	set_reg_block(&TIM8->CCMR1, 1, 15, value);
}
void STM32446Tim8_oc2m(uint8_t value)
{
	set_reg_block(&TIM8->CCMR1, 3, 12, value);
}
void STM32446Tim8_ic2f(uint8_t value)
{
	set_reg_block(&TIM8->CCMR1, 4, 12, value);
}
void STM32446Tim8_oc2pe(uint8_t state)
{
	set_reg_block(&TIM8->CCMR1, 1, 11, state);
}
void STM32446Tim8_oc2fe(uint8_t state)
{
	set_reg_block(&TIM8->CCMR1, 1, 10, state);
}
void STM32446Tim8_ic2psc(uint8_t value)
{
	set_reg_block(&TIM8->CCMR1, 2, 10, value);
}
void STM32446Tim8_cc2s(uint8_t value)
{
	set_reg_block(&TIM8->CCMR1, 2, 8, value);
}
void STM32446Tim8_oc1ce(uint8_t value)
{
	set_reg_block(&TIM8->CCMR1, 1, 7, value);
}
void STM32446Tim8_oc1m(uint8_t value)
{
	set_reg_block(&TIM8->CCMR1, 3, 4, value);
}
void STM32446Tim8_ic1f(uint8_t value)
{
	set_reg_block(&TIM8->CCMR1, 4, 4, value);
}
void STM32446Tim8_oc1pe(uint8_t state)
{
	set_reg_block(&TIM8->CCMR1, 1, 3, state);
}
void STM32446Tim8_oc1fe(uint8_t state)
{
	set_reg_block(&TIM8->CCMR1, 1, 2, state);
}
void STM32446Tim8_ic1psc(uint8_t value)
{
	set_reg_block(&TIM8->CCMR1, 2, 2, value);
}
void STM32446Tim8_cc1s(uint8_t value)
{
	set_reg_block(&TIM8->CCMR1, 2, 0, value);
}
// CCMR2
void STM32446Tim8_oc4ce(uint8_t value)
{
	set_reg_block(&TIM8->CCMR2, 1, 15, value);
}
void STM32446Tim8_oc4m(uint8_t value)
{
	set_reg_block(&TIM8->CCMR2, 3, 12, value);
}
void STM32446Tim8_ic4f(uint8_t value)
{
	set_reg_block(&TIM8->CCMR2, 4, 12, value);
}
void STM32446Tim8_oc4pe(uint8_t state)
{
	set_reg_block(&TIM8->CCMR2, 1, 11, state);
}
void STM32446Tim8_oc4fe(uint8_t state)
{
	set_reg_block(&TIM8->CCMR2, 1, 10, state);
}
void STM32446Tim8_ic4psc(uint8_t value)
{
	set_reg_block(&TIM8->CCMR2, 2, 10, value);
}
void STM32446Tim8_cc4s(uint8_t value)
{
	set_reg_block(&TIM8->CCMR2, 2, 8, value);
}
void STM32446Tim8_oc3ce(uint8_t value)
{
	set_reg_block(&TIM8->CCMR2, 1, 7, value);
}
void STM32446Tim8_oc3m(uint8_t value)
{
	set_reg_block(&TIM8->CCMR2, 3, 4, value);
}
void STM32446Tim8_ic3f(uint8_t value)
{
	set_reg_block(&TIM8->CCMR2, 4, 4, value);
}
void STM32446Tim8_oc3pe(uint8_t state)
{
	set_reg_block(&TIM8->CCMR2, 1, 3, state);
}
void STM32446Tim8_oc3fe(uint8_t state)
{
	set_reg_block(&TIM8->CCMR2, 1, 2, state);
}
void STM32446Tim8_ic3psc(uint8_t value)
{
	set_reg_block(&TIM8->CCMR2, 2, 2, value);
}
void STM32446Tim8_cc3s(uint8_t value)
{
	set_reg_block(&TIM8->CCMR2, 2, 0, value);
}
// CCER
void STM32446Tim8_cc4np(uint8_t state)
{
	set_reg_block(&TIM8->CCER, 1, 15, state);
}
void STM32446Tim8_cc4p(uint8_t state)
{
	set_reg_block(&TIM8->CCER, 1, 13, state);
}
void STM32446Tim8_cc4e(uint8_t state)
{
	set_reg_block(&TIM8->CCER, 1, 12, state);
}
void STM32446Tim8_cc3np(uint8_t state)
{
	set_reg_block(&TIM8->CCER, 1, 11, state);
}
void STM32446Tim8_cc3ne(uint8_t state)
{
	set_reg_block(&TIM8->CCER, 1, 11, state);
}
void STM32446Tim8_cc3p(uint8_t state)
{
	set_reg_block(&TIM8->CCER, 1, 9, state);
}
void STM32446Tim8_cc3e(uint8_t state)
{
	set_reg_block(&TIM8->CCER, 1, 8, state);
}
void STM32446Tim8_cc2np(uint8_t state)
{
	set_reg_block(&TIM8->CCER, 1, 7, state);
}
void STM32446Tim8_cc2ne(uint8_t state)
{
	set_reg_block(&TIM8->CCER, 1, 6, state);
}
void STM32446Tim8_cc2p(uint8_t state)
{
	set_reg_block(&TIM8->CCER, 1, 5, state);
}
void STM32446Tim8_cc2e(uint8_t state)
{
	set_reg_block(&TIM8->CCER, 1, 4, state);
}
void STM32446Tim8_cc1np(uint8_t state)
{
	set_reg_block(&TIM8->CCER, 1, 3, state);
}
void STM32446Tim8_cc1ne(uint8_t state)
{
	set_reg_block(&TIM8->CCER, 1, 2, state);
}
void STM32446Tim8_cc1p(uint8_t state)
{
	set_reg_block(&TIM8->CCER, 1, 1, state);
}
void STM32446Tim8_cc1e(uint8_t state)
{
	set_reg_block(&TIM8->CCER, 1, 0, state);
}
// CNT
...
// BDTR
void STM32446Tim8_moe(uint8_t state)
{
	set_reg_block(&TIM8->BDTR, 1, 15, state);
}
void STM32446Tim8_aoe(uint8_t state)
{
	set_reg_block(&TIM8->BDTR, 1, 14, state);
}
void STM32446Tim8_bkp(uint8_t state)
{
	set_reg_block(&TIM8->BDTR, 1, 13, state);
}
void STM32446Tim8_bke(uint8_t state)
{
	set_reg_block(&TIM8->BDTR, 1, 12, state);
}
void STM32446Tim8_ossr(uint8_t state)
{
	set_reg_block(&TIM8->BDTR, 1, 11, state);
}
void STM32446Tim8_ossi(uint8_t state)
{
	set_reg_block(&TIM8->BDTR, 1, 10, state);
}
void STM32446Tim8_lock(uint8_t value)
{
	set_reg_block(&TIM8->BDTR, 2, 8, value);
}
void STM32446Tim8_dtg(uint8_t value)
{
	set_reg_block(&TIM8->BDTR, 8, 0, value);
}
// DCR
void STM32446Tim8_dbl(uint8_t value)
{
	set_reg_block(&TIM8->DCR, 5, 8, value);
}
void STM32446Tim8_dba(uint8_t value)
{
	set_reg_block(&TIM8->DCR, 5, 0, value);
}
// DMAR
