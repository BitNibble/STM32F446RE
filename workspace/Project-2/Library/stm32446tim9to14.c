...
/*** TIM9 ***/
/************/
void STM32446Tim9Clock(uint8_t state)
{
	if(state){RCC->APB2ENR |= (1 << 16);}else{RCC->APB2ENR &= ~(1 << 16);}
}
void STM32446Tim9Nvic(uint8_t state)
{ // 24
...
{
	set_reg_block(&TIM9->CR1, 2, 8, value);
}
uint8_t STM32446Tim9_get_ckd(void)
{
	return get_reg_block(TIM9->CR1, 2, 8);
}
void STM32446Tim9_set_apre(uint8_t state)
{
	set_reg_block(&TIM9->CR1, 1, 7, state);
}
void STM32446Tim9_set_opm(uint8_t state)
{
	set_reg_block(&TIM9->CR1, 1, 3, state);
}
void STM32446Tim9_set_urs(uint8_t state)
{
	set_reg_block(&TIM9->CR1, 1, 2, state);
}
void STM32446Tim9_set_udis(uint8_t state)
{
	set_reg_block(&TIM9->CR1, 1, 1, state);
}
void STM32446Tim9_cen(uint8_t state)
{
	set_reg_block(&TIM9->CR1, 1, 0, state);
}
// SMCR
void STM32446Tim9_msm(uint8_t state)
{
	set_reg_block(&TIM9->SMCR, 1, 7, state);
}
void STM32446Tim9_ts(uint8_t value)
{
	set_reg_block(&TIM9->SMCR, 3, 4, value);
}
void STM32446Tim9_sms(uint8_t value)
{
	set_reg_block(&TIM9->SMCR, 3, 0, value);
}
// DIER
void STM32446Tim9_tie(uint8_t state)
{
	set_reg_block(&TIM9->DIER, 1, 6, state);
}
void STM32446Tim9_cc2ie(uint8_t state)
{
	set_reg_block(&TIM9->DIER, 1, 2, state);
}
void STM32446Tim9_cc1ie(uint8_t state)
{
	set_reg_block(&TIM9->DIER, 1, 1, state);
}
void STM32446Tim9_uie(uint8_t state)
{
	set_reg_block(&TIM9->DIER, 1, 0, state);
}
// SR
uint8_t STM32446Tim9_cc2of(void)
{
	return get_reg_block(TIM9->SR, 1, 10);
}
void STM32446Tim9_clear_cc2of(void)
{
	set_reg_block(&TIM9->SR, 1, 10, 0);
}
uint8_t STM32446Tim9_cc1of(void)
{
	return get_reg_block(TIM9->SR, 1, 9);
}
void STM32446Tim9_clear_cc1of(void)
{
	set_reg_block(&TIM9->SR, 1, 9, 0);
}
uint8_t STM32446Tim9_tif(void)
{
	return get_reg_block(TIM9->SR, 1, 6);
}
void STM32446Tim9_clear_tif(void)
{
	set_reg_block(&TIM9->SR, 1, 6, 0);
}
uint8_t STM32446Tim9_cc2if(void)
{
	return get_reg_block(TIM9->SR, 1, 2);
}
void STM32446Tim9_clear_cc2if(void)
{
	set_reg_block(&TIM9->SR, 1, 2, 0);
}
uint8_t STM32446Tim9_cc1if(void)
{
	return get_reg_block(TIM9->SR, 1, 1);
}
void STM32446Tim9_clear_cc1if(void)
{
	set_reg_block(&TIM9->SR, 1, 1, 0);
}
uint8_t STM32446Tim9_uif(void)
{
	return get_reg_block(TIM9->SR, 1, 0);
}
void STM32446Tim9_clear_uif(void)
{
	set_reg_block(&TIM9->SR, 1, 0, 0);
}
// EGR
void STM32446Tim9_tg(void)
{
	set_reg_block(&TIM9->EGR, 1, 6, 1);
}
void STM32446Tim9_cc2g(void)
{
	set_reg_block(&TIM9->EGR, 1, 2, 1);
}
void STM32446Tim9_cc1g(void)
{
	set_reg_block(&TIM9->EGR, 1, 1, 1);
}
void STM32446Tim9_ug(void)
{
	set_reg_block(&TIM9->EGR, 1, 0, 1);
}
// CCMR1
void STM32446Tim9_oc2m(uint8_t value)
{
	set_reg_block(&TIM9->CCMR1, 3, 12, value);
}
void STM32446Tim9_ic2f(uint8_t value)
{
	set_reg_block(&TIM9->CCMR1, 4, 12, value);
}
void STM32446Tim9_oc2pe(uint8_t state)
{
	set_reg_block(&TIM9->CCMR1, 1, 11, state);
}
void STM32446Tim9_oc2fe(uint8_t state)
{
	set_reg_block(&TIM9->CCMR1, 1, 10, state);
}
void STM32446Tim9_ic2psc(uint8_t value)
{
	set_reg_block(&TIM9->CCMR1, 2, 10, value);
}
void STM32446Tim9_cc2s(uint8_t value)
{
	set_reg_block(&TIM9->CCMR1, 2, 8, value);
}
void STM32446Tim9_oc1m(uint8_t value)
{
	set_reg_block(&TIM9->CCMR1, 3, 4, value);
}
void STM32446Tim9_ic1f(uint8_t value)
{
	set_reg_block(&TIM9->CCMR1, 4, 4, value);
}
void STM32446Tim9_oc1pe(uint8_t state)
{
	set_reg_block(&TIM9->CCMR1, 1, 3, state);
}
void STM32446Tim9_oc1fe(uint8_t state)
{
	set_reg_block(&TIM9->CCMR1, 1, 2, state);
}
void STM32446Tim9_ic1psc(uint8_t value)
{
	set_reg_block(&TIM9->CCMR1, 2, 2, value);
}
void STM32446Tim9_cc1s(uint8_t value)
{
	set_reg_block(&TIM9->CCMR1, 2, 0, value);
}
// CCER
void STM32446Tim9_cc2np(uint8_t state)
{
	set_reg_block(&TIM9->CCER, 1, 7, state);
}
void STM32446Tim9_cc2p(uint8_t state)
{
	set_reg_block(&TIM9->CCER, 1, 5, state);
}
void STM32446Tim9_cc2e(uint8_t state)
{
	set_reg_block(&TIM9->CCER, 1, 4, state);
}
void STM32446Tim9_cc1np(uint8_t state)
{
	set_reg_block(&TIM9->CCER, 1, 3, state);
}
void STM32446Tim9_cc1p(uint8_t state)
{
	set_reg_block(&TIM9->CCER, 1, 1, state);
}
void STM32446Tim9_cc1e(uint8_t state)
{
	set_reg_block(&TIM9->CCER, 1, 0, state);
}
// CNT
...
/*** TIM10 ***/
/*************/
void STM32446Tim10Clock(uint8_t state)
{
	if(state){RCC->APB2ENR |= (1 << 17);}else{RCC->APB2ENR &= ~(1 << 17);}
}
void STM32446Tim10Nvic(uint8_t state)
{ // 25
...
{
	return get_reg_block(TIM10->CR1, 2, 8);
}
void STM32446Tim10_set_apre(uint8_t state)
{
	set_reg_block(&TIM10->CR1, 1, 7, state);
}
void STM32446Tim10_set_opm(uint8_t state)
{
	set_reg_block(&TIM10->CR1, 1, 3, state);
}
void STM32446Tim10_set_urs(uint8_t state)
{
	set_reg_block(&TIM10->CR1, 1, 2, state);
}
void STM32446Tim10_set_udis(uint8_t state)
{
	set_reg_block(&TIM10->CR1, 1, 1, state);
}
void STM32446Tim10_cen(uint8_t state)
{
	set_reg_block(&TIM10->CR1, 1, 0, state);
}
// DIER
void STM32446Tim10_tie(uint8_t state)
{
	set_reg_block(&TIM10->DIER, 1, 6, state);
}
void STM32446Tim10_cc2ie(uint8_t state)
{
	set_reg_block(&TIM10->DIER, 1, 2, state);
}
void STM32446Tim10_cc1ie(uint8_t state)
{
	set_reg_block(&TIM10->DIER, 1, 1, state);
}
void STM32446Tim10_uie(uint8_t state)
{
	set_reg_block(&TIM10->DIER, 1, 0, state);
}
// SR
uint8_t STM32446Tim10_cc2of(void)
{
	return get_reg_block(TIM10->SR, 1, 10);
}
void STM32446Tim10_clear_cc2of(void)
{
	set_reg_block(&TIM10->SR, 1, 10, 0);
}
uint8_t STM32446Tim10_cc1of(void)
{
	return get_reg_block(TIM10->SR, 1, 9);
}
void STM32446Tim10_clear_cc1of(void)
{
	set_reg_block(&TIM10->SR, 1, 9, 0);
}
uint8_t STM32446Tim10_tif(void)
{
	return get_reg_block(TIM10->SR, 1, 6);
}
void STM32446Tim10_clear_tif(void)
{
	set_reg_block(&TIM10->SR, 1, 6, 0);
}
uint8_t STM32446Tim10_cc2if(void)
{
	return get_reg_block(TIM10->SR, 1, 2);
}
void STM32446Tim10_clear_cc2if(void)
{
	set_reg_block(&TIM10->SR, 1, 2, 0);
}
uint8_t STM32446Tim10_cc1if(void)
{
	return get_reg_block(TIM10->SR, 1, 1);
}
void STM32446Tim10_clear_cc1if(void)
{
	set_reg_block(&TIM10->SR, 1, 1, 0);
}
uint8_t STM32446Tim10_uif(void)
{
	return get_reg_block(TIM10->SR, 1, 0);
}
void STM32446Tim10_clear_uif(void)
{
	set_reg_block(&TIM10->SR, 1, 0, 0);
}
// EGR
void STM32446Tim10_tg(void)
{
	set_reg_block(&TIM10->EGR, 1, 6, 1);
}
void STM32446Tim10_cc2g(void)
{
	set_reg_block(&TIM10->EGR, 1, 2, 1);
}
void STM32446Tim10_cc1g(void)
{
	set_reg_block(&TIM10->EGR, 1, 1, 1);
}
void STM32446Tim10_ug(void)
{
	set_reg_block(&TIM10->EGR, 1, 0, 1);
}
// CCMR1
void STM32446Tim10_oc2m(uint8_t value)
{
	set_reg_block(&TIM10->CCMR1, 3, 12, value);
}
void STM32446Tim10_ic2f(uint8_t value)
{
	set_reg_block(&TIM10->CCMR1, 4, 12, value);
}
void STM32446Tim10_oc2pe(uint8_t state)
{
	set_reg_block(&TIM10->CCMR1, 1, 11, state);
}
void STM32446Tim10_oc2fe(uint8_t state)
{
	set_reg_block(&TIM10->CCMR1, 1, 10, state);
}
void STM32446Tim10_ic2psc(uint8_t value)
{
	set_reg_block(&TIM10->CCMR1, 2, 10, value);
}
void STM32446Tim10_cc2s(uint8_t value)
{
	set_reg_block(&TIM10->CCMR1, 2, 8, value);
}
void STM32446Tim10_oc1m(uint8_t value)
{
	set_reg_block(&TIM10->CCMR1, 3, 4, value);
}
void STM32446Tim10_ic1f(uint8_t value)
{
	set_reg_block(&TIM10->CCMR1, 4, 4, value);
}
void STM32446Tim10_oc1pe(uint8_t state)
{
	set_reg_block(&TIM10->CCMR1, 1, 3, state);
}
void STM32446Tim10_oc1fe(uint8_t state)
{
	set_reg_block(&TIM10->CCMR1, 1, 2, state);
}
void STM32446Tim10_ic1psc(uint8_t value)
{
	set_reg_block(&TIM10->CCMR1, 2, 2, value);
}
void STM32446Tim10_cc1s(uint8_t value)
{
	set_reg_block(&TIM10->CCMR1, 2, 0, value);
}
// CCER
void STM32446Tim10_cc2np(uint8_t state)
{
	set_reg_block(&TIM10->CCER, 1, 7, state);
}
void STM32446Tim10_cc2p(uint8_t state)
{
	set_reg_block(&TIM10->CCER, 1, 5, state);
}
void STM32446Tim10_cc2e(uint8_t state)
{
	set_reg_block(&TIM10->CCER, 1, 4, state);
}
void STM32446Tim10_cc1np(uint8_t state)
{
	set_reg_block(&TIM10->CCER, 1, 3, state);
}
void STM32446Tim10_cc1p(uint8_t state)
{
	set_reg_block(&TIM10->CCER, 1, 1, state);
}
void STM32446Tim10_cc1e(uint8_t state)
{
	set_reg_block(&TIM10->CCER, 1, 0, state);
}
// CNT
...
{
	set_reg_block(&TIM10->OR, 2, 0, value);
}
/*************/
/*** TIM11 ***/
/*************/
void STM32446Tim11Clock(uint8_t state)
{
	if(state){RCC->APB2ENR |= (1 << 18);}else{RCC->APB2ENR &= ~(1 << 18);}
}
void STM32446Tim11Nvic(uint8_t state)
{ // 26
...
{
	return get_reg_block(TIM11->CR1, 2, 8);
}
void STM32446Tim11_set_apre(uint8_t state)
{
	set_reg_block(&TIM11->CR1, 1, 7, state);
}
void STM32446Tim11_set_opm(uint8_t state)
{
	set_reg_block(&TIM11->CR1, 1, 3, state);
}
void STM32446Tim11_set_urs(uint8_t state)
{
	set_reg_block(&TIM11->CR1, 1, 2, state);
}
void STM32446Tim11_set_udis(uint8_t state)
{
	set_reg_block(&TIM11->CR1, 1, 1, state);
}
void STM32446Tim11_cen(uint8_t state)
{
	set_reg_block(&TIM11->CR1, 1, 0, state);
}
// DIER
void STM32446Tim11_tie(uint8_t state)
{
	set_reg_block(&TIM11->DIER, 1, 6, state);
}
void STM32446Tim11_cc2ie(uint8_t state)
{
	set_reg_block(&TIM11->DIER, 1, 2, state);
}
void STM32446Tim11_cc1ie(uint8_t state)
{
	set_reg_block(&TIM11->DIER, 1, 1, state);
}
void STM32446Tim11_uie(uint8_t state)
{
	set_reg_block(&TIM11->DIER, 1, 0, state);
}
// SR
uint8_t STM32446Tim11_cc2of(void)
{
	return get_reg_block(TIM11->SR, 1, 10);
}
void STM32446Tim11_clear_cc2of(void)
{
	set_reg_block(&TIM11->SR, 1, 10, 0);
}
uint8_t STM32446Tim11_cc1of(void)
{
	return get_reg_block(TIM11->SR, 1, 9);
}
void STM32446Tim11_clear_cc1of(void)
{
	set_reg_block(&TIM11->SR, 1, 9, 0);
}
uint8_t STM32446Tim11_tif(void)
{
	return get_reg_block(TIM11->SR, 1, 6);
}
void STM32446Tim11_clear_tif(void)
{
	set_reg_block(&TIM11->SR, 1, 6, 0);
}
uint8_t STM32446Tim11_cc2if(void)
{
	return get_reg_block(TIM11->SR, 1, 2);
}
void STM32446Tim11_clear_cc2if(void)
{
	set_reg_block(&TIM11->SR, 1, 2, 0);
}
uint8_t STM32446Tim11_cc1if(void)
{
	return get_reg_block(TIM11->SR, 1, 1);
}
void STM32446Tim11_clear_cc1if(void)
{
	set_reg_block(&TIM11->SR, 1, 1, 0);
}
uint8_t STM32446Tim11_uif(void)
{
	return get_reg_block(TIM11->SR, 1, 0);
}
void STM32446Tim11_clear_uif(void)
{
	set_reg_block(&TIM11->SR, 1, 0, 0);
}
// EGR
void STM32446Tim11_tg(void)
{
	set_reg_block(&TIM11->EGR, 1, 6, 1);
}
void STM32446Tim11_cc2g(void)
{
	set_reg_block(&TIM11->EGR, 1, 2, 1);
}
void STM32446Tim11_cc1g(void)
{
	set_reg_block(&TIM11->EGR, 1, 1, 1);
}
void STM32446Tim11_ug(void)
{
	set_reg_block(&TIM11->EGR, 1, 0, 1);
}
// CCMR1
void STM32446Tim11_oc2m(uint8_t value)
{
	set_reg_block(&TIM11->CCMR1, 3, 12, value);
}
void STM32446Tim11_ic2f(uint8_t value)
{
	set_reg_block(&TIM11->CCMR1, 4, 12, value);
}
void STM32446Tim11_oc2pe(uint8_t state)
{
	set_reg_block(&TIM11->CCMR1, 1, 11, state);
}
void STM32446Tim11_oc2fe(uint8_t state)
{
	set_reg_block(&TIM11->CCMR1, 1, 10, state);
}
void STM32446Tim11_ic2psc(uint8_t value)
{
	set_reg_block(&TIM11->CCMR1, 2, 10, value);
}
void STM32446Tim11_cc2s(uint8_t value)
{
	set_reg_block(&TIM11->CCMR1, 2, 8, value);
}
void STM32446Tim11_oc1m(uint8_t value)
{
	set_reg_block(&TIM11->CCMR1, 3, 4, value);
}
void STM32446Tim11_ic1f(uint8_t value)
{
	set_reg_block(&TIM11->CCMR1, 4, 4, value);
}
void STM32446Tim11_oc1pe(uint8_t state)
{
	set_reg_block(&TIM11->CCMR1, 1, 3, state);
}
void STM32446Tim11_oc1fe(uint8_t state)
{
	set_reg_block(&TIM11->CCMR1, 1, 2, state);
}
void STM32446Tim11_ic1psc(uint8_t value)
{
	set_reg_block(&TIM11->CCMR1, 2, 2, value);
}
void STM32446Tim11_cc1s(uint8_t value)
{
	set_reg_block(&TIM11->CCMR1, 2, 0, value);
}
// CCER
void STM32446Tim11_cc2np(uint8_t state)
{
	set_reg_block(&TIM11->CCER, 1, 7, state);
}
void STM32446Tim11_cc2p(uint8_t state)
{
	set_reg_block(&TIM11->CCER, 1, 5, state);
}
void STM32446Tim11_cc2e(uint8_t state)
{
	set_reg_block(&TIM11->CCER, 1, 4, state);
}
void STM32446Tim11_cc1np(uint8_t state)
{
	set_reg_block(&TIM11->CCER, 1, 3, state);
}
void STM32446Tim11_cc1p(uint8_t state)
{
	set_reg_block(&TIM11->CCER, 1, 1, state);
}
void STM32446Tim11_cc1e(uint8_t state)
{
	set_reg_block(&TIM11->CCER, 1, 0, state);
}
// CNT
...
{
	set_reg_block(&TIM11->OR, 2, 0, value);
}
/*************/
/*** TIM12 ***/
/*************/
void STM32446Tim12Clock(uint8_t state)
{
	if(state){RCC->APB1ENR |= (1 << 6);}else{RCC->APB1ENR &= ~(1 << 6);}
}
void STM32446Tim12Nvic(uint8_t state)
{ // 43
...
{
	return get_reg_block(TIM12->CR1, 2, 8);
}
void STM32446Tim12_set_apre(uint8_t state)
{
	set_reg_block(&TIM12->CR1, 1, 7, state);
}
void STM32446Tim12_set_opm(uint8_t state)
{
	set_reg_block(&TIM12->CR1, 1, 3, state);
}
void STM32446Tim12_set_urs(uint8_t state)
{
	set_reg_block(&TIM12->CR1, 1, 2, state);
}
void STM32446Tim12_set_udis(uint8_t state)
{
	set_reg_block(&TIM12->CR1, 1, 1, state);
}
void STM32446Tim12_cen(uint8_t state)
{
	set_reg_block(&TIM12->CR1, 1, 0, state);
}
// SMCR
void STM32446Tim12_msm(uint8_t state)
{
	set_reg_block(&TIM12->SMCR, 1, 7, state);
}
void STM32446Tim12_ts(uint8_t value)
{
	set_reg_block(&TIM12->SMCR, 3, 4, value);
}
void STM32446Tim12_sms(uint8_t value)
{
	set_reg_block(&TIM12->SMCR, 3, 0, value);
}
// DIER
void STM32446Tim12_tie(uint8_t state)
{
	set_reg_block(&TIM12->DIER, 1, 6, state);
}
void STM32446Tim12_cc2ie(uint8_t state)
{
	set_reg_block(&TIM12->DIER, 1, 2, state);
}
void STM32446Tim12_cc1ie(uint8_t state)
{
	set_reg_block(&TIM12->DIER, 1, 1, state);
}
void STM32446Tim12_uie(uint8_t state)
{
	set_reg_block(&TIM12->DIER, 1, 0, state);
}
// SR
uint8_t STM32446Tim12_cc2of(void)
{
	return get_reg_block(TIM12->SR, 1, 10);
}
void STM32446Tim12_clear_cc2of(void)
{
	set_reg_block(&TIM12->SR, 1, 10, 0);
}
uint8_t STM32446Tim12_cc1of(void)
{
	return get_reg_block(TIM12->SR, 1, 9);
}
void STM32446Tim12_clear_cc1of(void)
{
	set_reg_block(&TIM12->SR, 1, 9, 0);
}
uint8_t STM32446Tim12_tif(void)
{
	return get_reg_block(TIM12->SR, 1, 6);
}
void STM32446Tim12_clear_tif(void)
{
	set_reg_block(&TIM12->SR, 1, 6, 0);
}
uint8_t STM32446Tim12_cc2if(void)
{
	return get_reg_block(TIM12->SR, 1, 2);
}
void STM32446Tim12_clear_cc2if(void)
{
	set_reg_block(&TIM12->SR, 1, 2, 0);
}
uint8_t STM32446Tim12_cc1if(void)
{
	return get_reg_block(TIM12->SR, 1, 1);
}
void STM32446Tim12_clear_cc1if(void)
{
	set_reg_block(&TIM12->SR, 1, 1, 0);
}
uint8_t STM32446Tim12_uif(void)
{
	return get_reg_block(TIM12->SR, 1, 0);
}
void STM32446Tim12_clear_uif(void)
{
	set_reg_block(&TIM12->SR, 1, 0, 0);
}
// EGR
void STM32446Tim12_tg(void)
{
	set_reg_block(&TIM12->EGR, 1, 6, 1);
}
void STM32446Tim12_cc2g(void)
{
	set_reg_block(&TIM12->EGR, 1, 2, 1);
}
void STM32446Tim12_cc1g(void)
{
	set_reg_block(&TIM12->EGR, 1, 1, 1);
}
void STM32446Tim12_ug(void)
{
	set_reg_block(&TIM12->EGR, 1, 0, 1);
}
// CCMR1
void STM32446Tim12_oc2m(uint8_t value)
{
	set_reg_block(&TIM12->CCMR1, 3, 12, value);
}
void STM32446Tim12_ic2f(uint8_t value)
{
	set_reg_block(&TIM12->CCMR1, 4, 12, value);
}
void STM32446Tim12_oc2pe(uint8_t state)
{
	set_reg_block(&TIM12->CCMR1, 1, 11, state);
}
void STM32446Tim12_oc2fe(uint8_t state)
{
	set_reg_block(&TIM12->CCMR1, 1, 10, state);
}
void STM32446Tim12_ic2psc(uint8_t value)
{
	set_reg_block(&TIM12->CCMR1, 2, 10, value);
}
void STM32446Tim12_cc2s(uint8_t value)
{
	set_reg_block(&TIM12->CCMR1, 2, 8, value);
}
void STM32446Tim12_oc1m(uint8_t value)
{
	set_reg_block(&TIM12->CCMR1, 3, 4, value);
}
void STM32446Tim12_ic1f(uint8_t value)
{
	set_reg_block(&TIM12->CCMR1, 4, 4, value);
}
void STM32446Tim12_oc1pe(uint8_t state)
{
	set_reg_block(&TIM12->CCMR1, 1, 3, state);
}
void STM32446Tim12_oc1fe(uint8_t state)
{
	set_reg_block(&TIM12->CCMR1, 1, 2, state);
}
void STM32446Tim12_ic1psc(uint8_t value)
{
	set_reg_block(&TIM12->CCMR1, 2, 2, value);
}
void STM32446Tim12_cc1s(uint8_t value)
{
	set_reg_block(&TIM12->CCMR1, 2, 0, value);
}
// CCER
void STM32446Tim12_cc2np(uint8_t state)
{
	set_reg_block(&TIM12->CCER, 1, 7, state);
}
void STM32446Tim12_cc2p(uint8_t state)
{
	set_reg_block(&TIM12->CCER, 1, 5, state);
}
void STM32446Tim12_cc2e(uint8_t state)
{
	set_reg_block(&TIM12->CCER, 1, 4, state);
}
void STM32446Tim12_cc1np(uint8_t state)
{
	set_reg_block(&TIM12->CCER, 1, 3, state);
}
void STM32446Tim12_cc1p(uint8_t state)
{
	set_reg_block(&TIM12->CCER, 1, 1, state);
}
void STM32446Tim12_cc1e(uint8_t state)
{
	set_reg_block(&TIM12->CCER, 1, 0, state);
}
// CNT
...
/*** TIM13 ***/
/*************/
void STM32446Tim13Clock(uint8_t state)
{
	if(state){
...
void STM32446Tim13Nvic(uint8_t state)
{ // 44
...
{
	return get_reg_block(TIM13->CR1, 2, 8);
}
void STM32446Tim13_set_apre(uint8_t state)
{
	set_reg_block(&TIM13->CR1, 1, 7, state);
}
void STM32446Tim13_set_opm(uint8_t state)
{
	set_reg_block(&TIM13->CR1, 1, 3, state);
}
void STM32446Tim13_set_urs(uint8_t state)
{
	set_reg_block(&TIM13->CR1, 1, 2, state);
}
void STM32446Tim13_set_udis(uint8_t state)
{
	set_reg_block(&TIM13->CR1, 1, 1, state);
}
void STM32446Tim13_cen(uint8_t state)
{
	set_reg_block(&TIM13->CR1, 1, 0, state);
}
// DIER
void STM32446Tim13_tie(uint8_t state)
{
	set_reg_block(&TIM13->DIER, 1, 6, state);
}
void STM32446Tim13_cc2ie(uint8_t state)
{
	set_reg_block(&TIM13->DIER, 1, 2, state);
}
void STM32446Tim13_cc1ie(uint8_t state)
{
	set_reg_block(&TIM13->DIER, 1, 1, state);
}
void STM32446Tim13_uie(uint8_t state)
{
	set_reg_block(&TIM13->DIER, 1, 0, state);
}
// SR
uint8_t STM32446Tim13_cc2of(void)
{
	return get_reg_block(TIM13->SR, 1, 10);
}
void STM32446Tim13_clear_cc2of(void)
{
	set_reg_block(&TIM13->SR, 1, 10, 0);
}
uint8_t STM32446Tim13_cc1of(void)
{
	return get_reg_block(TIM13->SR, 1, 9);
}
void STM32446Tim13_clear_cc1of(void)
{
	set_reg_block(&TIM13->SR, 1, 9, 0);
}
uint8_t STM32446Tim13_tif(void)
{
	return get_reg_block(TIM13->SR, 1, 6);
}
void STM32446Tim13_clear_tif(void)
{
	set_reg_block(&TIM13->SR, 1, 6, 0);
}
uint8_t STM32446Tim13_cc2if(void)
{
	return get_reg_block(TIM13->SR, 1, 2);
}
void STM32446Tim13_clear_cc2if(void)
{
	set_reg_block(&TIM13->SR, 1, 2, 0);
}
uint8_t STM32446Tim13_cc1if(void)
{
	return get_reg_block(TIM13->SR, 1, 1);
}
void STM32446Tim13_clear_cc1if(void)
{
	set_reg_block(&TIM13->SR, 1, 1, 0);
}
uint8_t STM32446Tim13_uif(void)
{
	return get_reg_block(TIM13->SR, 1, 0);
}
void STM32446Tim13_clear_uif(void)
{
	set_reg_block(&TIM13->SR, 1, 0, 0);
}
// EGR
void STM32446Tim13_tg(void)
{
	set_reg_block(&TIM13->EGR, 1, 6, 1);
}
void STM32446Tim13_cc2g(void)
{
	set_reg_block(&TIM13->EGR, 1, 2, 1);
}
void STM32446Tim13_cc1g(void)
{
	set_reg_block(&TIM13->EGR, 1, 1, 1);
}
void STM32446Tim13_ug(void)
{
	set_reg_block(&TIM13->EGR, 1, 0, 1);
}
// CCMR1
void STM32446Tim13_oc2m(uint8_t value)
{
	set_reg_block(&TIM13->CCMR1, 3, 12, value);
}
void STM32446Tim13_ic2f(uint8_t value)
{
	set_reg_block(&TIM13->CCMR1, 4, 12, value);
}
void STM32446Tim13_oc2pe(uint8_t state)
{
	set_reg_block(&TIM13->CCMR1, 1, 11, state);
}
void STM32446Tim13_oc2fe(uint8_t state)
{
	set_reg_block(&TIM13->CCMR1, 1, 10, state);
}
void STM32446Tim13_ic2psc(uint8_t value)
{
	set_reg_block(&TIM13->CCMR1, 2, 10, value);
}
void STM32446Tim13_cc2s(uint8_t value)
{
	set_reg_block(&TIM13->CCMR1, 2, 8, value);
}
void STM32446Tim13_oc1m(uint8_t value)
{
	set_reg_block(&TIM13->CCMR1, 3, 4, value);
}
void STM32446Tim13_ic1f(uint8_t value)
{
	set_reg_block(&TIM13->CCMR1, 4, 4, value);
}
void STM32446Tim13_oc1pe(uint8_t state)
{
	set_reg_block(&TIM13->CCMR1, 1, 3, state);
}
void STM32446Tim13_oc1fe(uint8_t state)
{
	set_reg_block(&TIM13->CCMR1, 1, 2, state);
}
void STM32446Tim13_ic1psc(uint8_t value)
{
	set_reg_block(&TIM13->CCMR1, 2, 2, value);
}
void STM32446Tim13_cc1s(uint8_t value)
{
	set_reg_block(&TIM13->CCMR1, 2, 0, value);
}
// CCER
void STM32446Tim13_cc2np(uint8_t state)
{
	set_reg_block(&TIM13->CCER, 1, 7, state);
}
void STM32446Tim13_cc2p(uint8_t state)
{
	set_reg_block(&TIM13->CCER, 1, 5, state);
}
void STM32446Tim13_cc2e(uint8_t state)
{
	set_reg_block(&TIM13->CCER, 1, 4, state);
}
void STM32446Tim13_cc1np(uint8_t state)
{
	set_reg_block(&TIM13->CCER, 1, 3, state);
}
void STM32446Tim13_cc1p(uint8_t state)
{
	set_reg_block(&TIM13->CCER, 1, 1, state);
}
void STM32446Tim13_cc1e(uint8_t state)
{
	set_reg_block(&TIM13->CCER, 1, 0, state);
}
// CNT
...
{
	set_reg_block(&TIM13->OR, 2, 0, value);
}
/*************/
/*** TIM14 ***/
/*************/
void STM32446Tim14Clock(uint8_t state)
{
	if(state){RCC->APB1ENR |= (1 << 8);}else{RCC->APB1ENR &= ~(1 << 8);}
}
void STM32446Tim14Nvic(uint8_t state)
{ // 45
...
{
	return get_reg_block(TIM14->CR1, 2, 8);
}
void STM32446Tim14_set_apre(uint8_t state)
{
	set_reg_block(&TIM14->CR1, 1, 7, state);
}
void STM32446Tim14_set_opm(uint8_t state)
{
	set_reg_block(&TIM14->CR1, 1, 3, state);
}
void STM32446Tim14_set_urs(uint8_t state)
{
	set_reg_block(&TIM14->CR1, 1, 2, state);
}
void STM32446Tim14_set_udis(uint8_t state)
{
	set_reg_block(&TIM14->CR1, 1, 1, state);
}
void STM32446Tim14_cen(uint8_t state)
{
	set_reg_block(&TIM14->CR1, 1, 0, state);
}
// DIER
void STM32446Tim14_tie(uint8_t state)
{
	set_reg_block(&TIM14->DIER, 1, 6, state);
}
void STM32446Tim14_cc2ie(uint8_t state)
{
	set_reg_block(&TIM14->DIER, 1, 2, state);
}
void STM32446Tim14_cc1ie(uint8_t state)
{
	set_reg_block(&TIM14->DIER, 1, 1, state);
}
void STM32446Tim14_uie(uint8_t state)
{
	set_reg_block(&TIM14->DIER, 1, 0, state);
}
// SR
uint8_t STM32446Tim14_cc2of(void)
{
	return get_reg_block(TIM14->SR, 1, 10);
}
void STM32446Tim14_clear_cc2of(void)
{
	set_reg_block(&TIM14->SR, 1, 10, 0);
}
uint8_t STM32446Tim14_cc1of(void)
{
	return get_reg_block(TIM14->SR, 1, 9);
}
void STM32446Tim14_clear_cc1of(void)
{
	set_reg_block(&TIM14->SR, 1, 9, 0);
}
uint8_t STM32446Tim14_tif(void)
{
	return get_reg_block(TIM14->SR, 1, 6);
}
void STM32446Tim14_clear_tif(void)
{
	set_reg_block(&TIM14->SR, 1, 6, 0);
}
uint8_t STM32446Tim14_cc2if(void)
{
	return get_reg_block(TIM14->SR, 1, 2);
}
void STM32446Tim14_clear_cc2if(void)
{
	set_reg_block(&TIM14->SR, 1, 2, 0);
}
uint8_t STM32446Tim14_cc1if(void)
{
	return get_reg_block(TIM14->SR, 1, 1);
}
void STM32446Tim14_clear_cc1if(void)
{
	set_reg_block(&TIM14->SR, 1, 1, 0);
}
uint8_t STM32446Tim14_uif(void)
{
	return get_reg_block(TIM14->SR, 1, 0);
}
void STM32446Tim14_clear_uif(void)
{
	set_reg_block(&TIM14->SR, 1, 0, 0);
}
// EGR
void STM32446Tim14_tg(void)
{
	set_reg_block(&TIM14->EGR, 1, 6, 1);
}
void STM32446Tim14_cc2g(void)
{
	set_reg_block(&TIM14->EGR, 1, 2, 1);
}
void STM32446Tim14_cc1g(void)
{
	set_reg_block(&TIM14->EGR, 1, 1, 1);
}
void STM32446Tim14_ug(void)
{
	set_reg_block(&TIM14->EGR, 1, 0, 1);
}
// CCMR1
void STM32446Tim14_oc2m(uint8_t value)
{
	set_reg_block(&TIM14->CCMR1, 3, 12, value);
}
void STM32446Tim14_ic2f(uint8_t value)
{
	set_reg_block(&TIM14->CCMR1, 4, 12, value);
}
void STM32446Tim14_oc2pe(uint8_t state)
{
	set_reg_block(&TIM14->CCMR1, 1, 11, state);
}
void STM32446Tim14_oc2fe(uint8_t state)
{
	set_reg_block(&TIM14->CCMR1, 1, 10, state);
}
void STM32446Tim14_ic2psc(uint8_t value)
{
	set_reg_block(&TIM14->CCMR1, 2, 10, value);
}
void STM32446Tim14_cc2s(uint8_t value)
{
	set_reg_block(&TIM14->CCMR1, 2, 8, value);
}
void STM32446Tim14_oc1m(uint8_t value)
{
	set_reg_block(&TIM14->CCMR1, 3, 4, value);
}
void STM32446Tim14_ic1f(uint8_t value)
{
	set_reg_block(&TIM14->CCMR1, 4, 4, value);
}
void STM32446Tim14_oc1pe(uint8_t state)
{
	set_reg_block(&TIM14->CCMR1, 1, 3, state);
}
void STM32446Tim14_oc1fe(uint8_t state)
{
	set_reg_block(&TIM14->CCMR1, 1, 2, state);
}
void STM32446Tim14_ic1psc(uint8_t value)
{
	set_reg_block(&TIM14->CCMR1, 2, 2, value);
}
void STM32446Tim14_cc1s(uint8_t value)
{
	set_reg_block(&TIM14->CCMR1, 2, 0, value);
}
// CCER
void STM32446Tim14_cc2np(uint8_t state)
{
	set_reg_block(&TIM14->CCER, 1, 7, state);
}
void STM32446Tim14_cc2p(uint8_t state)
{
	set_reg_block(&TIM14->CCER, 1, 5, state);
}
void STM32446Tim14_cc2e(uint8_t state)
{
	set_reg_block(&TIM14->CCER, 1, 4, state);
}
void STM32446Tim14_cc1np(uint8_t state)
{
	set_reg_block(&TIM14->CCER, 1, 3, state);
}
void STM32446Tim14_cc1p(uint8_t state)
{
	set_reg_block(&TIM14->CCER, 1, 1, state);
}
void STM32446Tim14_cc1e(uint8_t state)
{
	set_reg_block(&TIM14->CCER, 1, 0, state);
}
// CNT
...
{
	set_reg_block(&TIM14->OR, 2, 0, value);
}
