...
void STM32446FLASH_nvic(uint8_t state);
/*** FLASH Bit Mapping Header ***/
// ACR
void STM32446FLASH_acr_dcrst(uint8_t state);
void STM32446FLASH_acr_icrst(uint8_t state);
void STM32446FLASH_acr_dcen(uint8_t state);
void STM32446FLASH_acr_icen(uint8_t state);
void STM32446FLASH_acr_prften(uint8_t state);
...
void STM32446FLASH_cr_errie(uint8_t state);
void STM32446FLASH_cr_eopie(uint8_t state);
void STM32446FLASH_cr_strt(void);
void STM32446FLASH_cr_psize(uint8_t value);
void STM32446FLASH_cr_snb(uint8_t value);
void STM32446FLASH_cr_mer(uint8_t state);
void STM32446FLASH_cr_ser(uint8_t state);
void STM32446FLASH_cr_pg(uint8_t state);
// OPTCR
void STM32446FLASH_optcr_sprmod(uint8_t state);
...
void STM32446FLASH_optcr_nrst_stdby(uint8_t state);
void STM32446FLASH_optcr_nrst_stop(uint8_t state);
void STM32446FLASH_optcr_wdg_sw(uint8_t state);
void STM32446FLASH_optcr_bor_lev(uint8_t value);
void STM32446FLASH_optcr_optstrt(uint8_t state);
void STM32446FLASH_optcr_optlock(uint8_t state);
// KEYR
