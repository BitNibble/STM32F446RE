...
typedef struct{
	...
	void (*apre)(uint8_t state);
	void (*cms)(uint8_t value);
	void (*dir)(uint8_t state);
	void (*opm)(uint8_t state);
	void (*urs)(uint8_t state);
	void (*udis)(uint8_t state);
	void (*cen)(uint8_t state);
}STM32446TIM2_CR1, STM32446TIM3_CR1, STM32446TIM4_CR1, STM32446TIM5_CR1;
// CR2
typedef struct{
	void (*ois4)(uint8_t state);
	void (*ois3n)(uint8_t state);
	void (*ois3)(uint8_t state);
	void (*ois2n)(uint8_t state);
	void (*ois2)(uint8_t state);
	void (*ois1n)(uint8_t state);
	void (*ois1)(uint8_t state);
	void (*ti1s)(uint8_t state);
	void (*mms)(uint8_t value);
	void (*ccds)(uint8_t state);
	void (*ccus)(uint8_t state);
	void (*ccpc)(uint8_t state);
}STM32446TIM2_CR2, STM32446TIM3_CR2, STM32446TIM4_CR2, STM32446TIM5_CR2;
// SMCR
typedef struct{
	void (*etp)(uint8_t state);
	void (*ece)(uint8_t state);
	void (*etps)(uint8_t value);
	void (*etf)(uint8_t value);
	void (*msm)(uint8_t state);
	void (*ts)(uint8_t value);
	void (*sms)(uint8_t value);
}STM32446TIM2_SMCR, STM32446TIM3_SMCR, STM32446TIM4_SMCR, STM32446TIM5_SMCR;
// DIER
typedef struct{
	void (*tde)(uint8_t state);
	void (*comde)(uint8_t state);
	void (*cc4de)(uint8_t state);
	void (*cc3de)(uint8_t state);
	void (*cc2de)(uint8_t state);
	void (*cc1de)(uint8_t state);
	void (*ude)(uint8_t state);
	void (*bie)(uint8_t state);
	void (*tie)(uint8_t state);
	void (*comie)(uint8_t state);
	void (*cc4ie)(uint8_t state);
	void (*cc3ie)(uint8_t state);
	void (*cc2ie)(uint8_t state);
	void (*cc1ie)(uint8_t state);
	void (*uie)(uint8_t state);
...
// CCMR1
typedef struct{
	void (*oc2ce)(uint8_t state);
	void (*oc2m)(uint8_t value);
	void (*ic2f)(uint8_t value);
	void (*oc2pe)(uint8_t state);
	void (*oc2fe)(uint8_t state);
	void (*ic2psc)(uint8_t value);
	void (*cc2s)(uint8_t value);
	void (*oc1ce)(uint8_t state);
	void (*oc1m)(uint8_t value);
	void (*ic1f)(uint8_t value);
	void (*oc1pe)(uint8_t state);
	void (*oc1fe)(uint8_t state);
...
// CCMR2
typedef struct{
	void (*oc4ce)(uint8_t state);
	void (*oc4m)(uint8_t value);
	void (*ic4f)(uint8_t value);
	void (*oc4pe)(uint8_t state);
	void (*oc4fe)(uint8_t state);
	void (*ic4psc)(uint8_t value);
	void (*cc4s)(uint8_t value);
	void (*oc3ce)(uint8_t state);
	void (*oc3m)(uint8_t value);
	void (*ic3f)(uint8_t value);
	void (*oc3pe)(uint8_t state);
	void (*oc3fe)(uint8_t state);
...
// CCER
typedef struct{
	void (*cc4np)(uint8_t state);
	void (*cc4p)(uint8_t state);
	void (*cc4e)(uint8_t state);
	void (*cc3np)(uint8_t state);
	void (*cc3ne)(uint8_t state);
	void (*cc3p)(uint8_t state);
	void (*cc3e)(uint8_t state);
	void (*cc2np)(uint8_t state);
	void (*cc2ne)(uint8_t state);
	void (*cc2p)(uint8_t state);
	void (*cc2e)(uint8_t state);
	void (*cc1np)(uint8_t state);
	void (*cc1ne)(uint8_t state);
	void (*cc1p)(uint8_t state);
	void (*cc1e)(uint8_t state);
}STM32446TIM2_CCER, STM32446TIM3_CCER, STM32446TIM4_CCER, STM32446TIM5_CCER;
// BDTR
typedef struct{
	void (*moe)(uint8_t state);
	void (*aoe)(uint8_t state);
	void (*bkp)(uint8_t state);
	void (*bke)(uint8_t state);
	void (*ossr)(uint8_t state);
	void (*ossi)(uint8_t state);
