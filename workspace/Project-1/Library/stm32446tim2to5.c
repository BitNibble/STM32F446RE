...
/*** TIM2 ***/
/************/
void STM32446Tim2Clock(uint8_t state)
{
	if(state){RCC->APB1ENR |= (1 << 0);}else{RCC->APB1ENR &= ~(1 << 0);}
}
void STM32446Tim2Nvic(uint8_t state)
{ // 28
...
{
	set_reg_block(&TIM2->CR1, 2, 8, value);
}
uint8_t STM32446Tim2_get_ckd(void)
{
	return get_reg_block(TIM2->CR1, 2, 8);
}
void STM32446Tim2_set_apre(uint8_t state)
{
	set_reg_block(&TIM2->CR1, 1, 7, state);
}
void STM32446Tim2_set_cms(uint8_t value)
{
	set_reg_block(&TIM2->CR1, 2, 5, value);
}
void STM32446Tim2_set_dir(uint8_t state)
{
	set_reg_block(&TIM2->CR1, 1, 4, state);
}
void STM32446Tim2_set_opm(uint8_t state)
{
	set_reg_block(&TIM2->CR1, 1, 3, state);
}
void STM32446Tim2_set_urs(uint8_t state)
{
	set_reg_block(&TIM2->CR1, 1, 2, state);
}
void STM32446Tim2_set_udis(uint8_t state)
{
	set_reg_block(&TIM2->CR1, 1, 1, state);
}
void STM32446Tim2_cen(uint8_t state)
{
	set_reg_block(&TIM2->CR1, 1, 0, state);
}
// CR2
void STM32446Tim2_ti1s(uint8_t state)
{
	set_reg_block(&TIM2->CR2, 1, 7, state);
}
void STM32446Tim2_mms(uint8_t value)
{
	set_reg_block(&TIM2->CR2, 3, 4, value);
}
void STM32446Tim2_ccds(uint8_t state)
{
	set_reg_block(&TIM2->CR2, 1, 3, state);
}
// SMCR
void STM32446Tim2_etp(uint8_t state)
{
	set_reg_block(&TIM2->SMCR, 1, 15, state);
}
void STM32446Tim2_ece(uint8_t state)
{
	set_reg_block(&TIM2->SMCR, 1, 14, state);
}
void STM32446Tim2_etps(uint8_t value)
{
	set_reg_block(&TIM2->SMCR, 2, 12, value);
}
void STM32446Tim2_etf(uint8_t value)
{
	set_reg_block(&TIM2->SMCR, 4, 8, value);
}
void STM32446Tim2_msm(uint8_t state)
{
	set_reg_block(&TIM2->SMCR, 1, 7, state);
}
void STM32446Tim2_ts(uint8_t value)
{
	set_reg_block(&TIM2->SMCR, 3, 4, value);
}
void STM32446Tim2_sms(uint8_t value)
{
	set_reg_block(&TIM2->SMCR, 3, 0, value);
}
// DIER
void STM32446Tim2_tde(uint8_t state)
{
	set_reg_block(&TIM2->DIER, 1, 14, state);
}
void STM32446Tim2_cc4de(uint8_t state)
{
	set_reg_block(&TIM2->DIER, 1, 12, state);
}
void STM32446Tim2_cc3de(uint8_t state)
{
	set_reg_block(&TIM2->DIER, 1, 11, state);
}
void STM32446Tim2_cc2de(uint8_t state)
{
	set_reg_block(&TIM2->DIER, 1, 10, state);
}
void STM32446Tim2_cc1de(uint8_t state)
{
	set_reg_block(&TIM2->DIER, 1, 9, state);
}
void STM32446Tim2_ude(uint8_t state)
{
	set_reg_block(&TIM2->DIER, 1, 8, state);
}
void STM32446Tim2_tie(uint8_t state)
{
	set_reg_block(&TIM2->DIER, 1, 6, state);
}
void STM32446Tim2_cc4ie(uint8_t state)
{
	set_reg_block(&TIM2->DIER, 1, 4, state);
}
void STM32446Tim2_cc3ie(uint8_t state)
{
	set_reg_block(&TIM2->DIER, 1, 3, state);
}
void STM32446Tim2_cc2ie(uint8_t state)
{
	set_reg_block(&TIM2->DIER, 1, 2, state);
}
void STM32446Tim2_cc1ie(uint8_t state)
{
	set_reg_block(&TIM2->DIER, 1, 1, state);
}
void STM32446Tim2_uie(uint8_t state)
{
	set_reg_block(&TIM2->DIER, 1, 0, state);
}
// SR
uint8_t STM32446Tim2_cc4of(void)
{
	return get_reg_block(TIM2->SR, 1, 12);
}
void STM32446Tim2_clear_cc4of(void)
{
	set_reg_block(&TIM2->SR, 1, 12, 0);
}
uint8_t STM32446Tim2_cc3of(void)
{
	return get_reg_block(TIM2->SR, 1, 11);
}
void STM32446Tim2_clear_cc3of(void)
{
	set_reg_block(&TIM2->SR, 1, 11, 0);
}
uint8_t STM32446Tim2_cc2of(void)
{
	return get_reg_block(TIM2->SR, 1, 10);
}
void STM32446Tim2_clear_cc2of(void)
{
	set_reg_block(&TIM2->SR, 1, 10, 0);
}
uint8_t STM32446Tim2_cc1of(void)
{
	return get_reg_block(TIM2->SR, 1, 9);
}
void STM32446Tim2_clear_cc1of(void)
{
	set_reg_block(&TIM2->SR, 1, 9, 0);
}
uint8_t STM32446Tim2_tif(void)
{
	return get_reg_block(TIM2->SR, 1, 6);
}
void STM32446Tim2_clear_tif(void)
{
	set_reg_block(&TIM2->SR, 1, 6, 0);
}
uint8_t STM32446Tim2_cc4if(void)
{
	return get_reg_block(TIM2->SR, 1, 4);
}
void STM32446Tim2_clear_cc4if(void)
{
	set_reg_block(&TIM2->SR, 1, 4, 0);
}
uint8_t STM32446Tim2_cc3if(void)
{
	return get_reg_block(TIM2->SR, 1, 3);
}
void STM32446Tim2_clear_cc3if(void)
{
	set_reg_block(&TIM2->SR, 1, 3, 0);
}
uint8_t STM32446Tim2_cc2if(void)
{
	return get_reg_block(TIM2->SR, 1, 2);
}
void STM32446Tim2_clear_cc2if(void)
{
	set_reg_block(&TIM2->SR, 1, 2, 0);
}
uint8_t STM32446Tim2_cc1if(void)
{
	return get_reg_block(TIM2->SR, 1, 1);
}
void STM32446Tim2_clear_cc1if(void)
{
	set_reg_block(&TIM2->SR, 1, 1, 0);
}
uint8_t STM32446Tim2_uif(void)
{
	return get_reg_block(TIM2->SR, 1, 0);
}
void STM32446Tim2_clear_uif(void)
{
	set_reg_block(&TIM2->SR, 1, 0, 0);
}
// EGR
void STM32446Tim2_tg(void)
{
	set_reg_block(&TIM2->EGR, 1, 6, 1);
}
void STM32446Tim2_cc4g(void)
{
	set_reg_block(&TIM2->EGR, 1, 4, 1);
}
void STM32446Tim2_cc3g(void)
{
	set_reg_block(&TIM2->EGR, 1, 3, 1);
}
void STM32446Tim2_cc2g(void)
{
	set_reg_block(&TIM2->EGR, 1, 2, 1);
}
void STM32446Tim2_cc1g(void)
{
	set_reg_block(&TIM2->EGR, 1, 1, 1);
}
void STM32446Tim2_ug(void)
{
	set_reg_block(&TIM2->EGR, 1, 0, 1);
}
// CCMR1
void STM32446Tim2_oc2ce(uint8_t value)
{
	set_reg_block(&TIM2->CCMR1, 1, 15, value);
}
void STM32446Tim2_oc2m(uint8_t value)
{
	set_reg_block(&TIM2->CCMR1, 3, 12, value);
}
void STM32446Tim2_ic2f(uint8_t value)
{
	set_reg_block(&TIM2->CCMR1, 4, 12, value);
}
void STM32446Tim2_oc2pe(uint8_t state)
{
	set_reg_block(&TIM2->CCMR1, 1, 11, state);
}
void STM32446Tim2_oc2fe(uint8_t state)
{
	set_reg_block(&TIM2->CCMR1, 1, 10, state);
}
void STM32446Tim2_ic2psc(uint8_t value)
{
	set_reg_block(&TIM2->CCMR1, 2, 10, value);
}
void STM32446Tim2_cc2s(uint8_t value)
{
	set_reg_block(&TIM2->CCMR1, 2, 8, value);
}
void STM32446Tim2_oc1ce(uint8_t value)
{
	set_reg_block(&TIM2->CCMR1, 1, 7, value);
}
void STM32446Tim2_oc1m(uint8_t value)
{
	set_reg_block(&TIM2->CCMR1, 3, 4, value);
}
void STM32446Tim2_ic1f(uint8_t value)
{
	set_reg_block(&TIM2->CCMR1, 4, 4, value);
}
void STM32446Tim2_oc1pe(uint8_t state)
{
	set_reg_block(&TIM2->CCMR1, 1, 3, state);
}
void STM32446Tim2_oc1fe(uint8_t state)
{
	set_reg_block(&TIM2->CCMR1, 1, 2, state);
}
void STM32446Tim2_ic1psc(uint8_t value)
{
	set_reg_block(&TIM2->CCMR1, 2, 2, value);
}
void STM32446Tim2_cc1s(uint8_t value)
{
	set_reg_block(&TIM2->CCMR1, 2, 0, value);
}
// CCMR2
void STM32446Tim2_oc4ce(uint8_t value)
{
	set_reg_block(&TIM2->CCMR2, 1, 15, value);
}
void STM32446Tim2_oc4m(uint8_t value)
{
	set_reg_block(&TIM2->CCMR2, 3, 12, value);
}
void STM32446Tim2_ic4f(uint8_t value)
{
	set_reg_block(&TIM2->CCMR2, 4, 12, value);
}
void STM32446Tim2_oc4pe(uint8_t state)
{
	set_reg_block(&TIM2->CCMR2, 1, 11, state);
}
void STM32446Tim2_oc4fe(uint8_t state)
{
	set_reg_block(&TIM2->CCMR2, 1, 10, state);
}
void STM32446Tim2_ic4psc(uint8_t value)
{
	set_reg_block(&TIM2->CCMR2, 2, 10, value);
}
void STM32446Tim2_cc4s(uint8_t value)
{
	set_reg_block(&TIM2->CCMR2, 2, 8, value);
}
void STM32446Tim2_oc3ce(uint8_t value)
{
	set_reg_block(&TIM2->CCMR2, 1, 7, value);
}
void STM32446Tim2_oc3m(uint8_t value)
{
	set_reg_block(&TIM2->CCMR2, 3, 4, value);
}
void STM32446Tim2_ic3f(uint8_t value)
{
	set_reg_block(&TIM2->CCMR2, 4, 4, value);
}
void STM32446Tim2_oc3pe(uint8_t state)
{
	set_reg_block(&TIM2->CCMR2, 1, 3, state);
}
void STM32446Tim2_oc3fe(uint8_t state)
{
	set_reg_block(&TIM2->CCMR2, 1, 2, state);
}
void STM32446Tim2_ic3psc(uint8_t value)
{
	set_reg_block(&TIM2->CCMR2, 2, 2, value);
}
void STM32446Tim2_cc3s(uint8_t value)
{
	set_reg_block(&TIM2->CCMR2, 2, 0, value);
}
// CCER
void STM32446Tim2_cc4np(uint8_t state)
{
	set_reg_block(&TIM2->CCER, 1, 15, state);
}
void STM32446Tim2_cc4p(uint8_t state)
{
	set_reg_block(&TIM2->CCER, 1, 13, state);
}
void STM32446Tim2_cc4e(uint8_t state)
{
	set_reg_block(&TIM2->CCER, 1, 12, state);
}
void STM32446Tim2_cc3np(uint8_t state)
{
	set_reg_block(&TIM2->CCER, 1, 11, state);
}
void STM32446Tim2_cc3p(uint8_t state)
{
	set_reg_block(&TIM2->CCER, 1, 9, state);
}
void STM32446Tim2_cc3e(uint8_t state)
{
	set_reg_block(&TIM2->CCER, 1, 8, state);
}
void STM32446Tim2_cc2np(uint8_t state)
{
	set_reg_block(&TIM2->CCER, 1, 7, state);
}
void STM32446Tim2_cc2p(uint8_t state)
{
	set_reg_block(&TIM2->CCER, 1, 5, state);
}
void STM32446Tim2_cc2e(uint8_t state)
{
	set_reg_block(&TIM2->CCER, 1, 4, state);
}
void STM32446Tim2_cc1np(uint8_t state)
{
	set_reg_block(&TIM2->CCER, 1, 3, state);
}
void STM32446Tim2_cc1p(uint8_t state)
{
	set_reg_block(&TIM2->CCER, 1, 1, state);
}
void STM32446Tim2_cc1e(uint8_t state)
{
	set_reg_block(&TIM2->CCER, 1, 0, state);
}
// CNT
...
{
	set_reg_block(&TIM2->DCR, 5, 8, value);
}
void STM32446Tim2_dba(uint8_t value)
{
	set_reg_block(&TIM2->DCR, 5, 0, value);
}
// DMAR
...
{
	set_reg_block(&TIM2->OR, 2, 10, value);
}
/************/
/*** TIM3 ***/
/************/
void STM32446Tim3Clock(uint8_t state)
{
	if(state){RCC->APB1ENR |= (1 << 1);}else{RCC->APB1ENR &= ~(1 << 1);}
}
void STM32446Tim3Nvic(uint8_t state)
{ // 29
...
{
	return get_reg_block(TIM3->CR1, 2, 8);
}
void STM32446Tim3_set_apre(uint8_t state)
{
	set_reg_block(&TIM3->CR1, 1, 7, state);
}
void STM32446Tim3_set_cms(uint8_t value)
{
	set_reg_block(&TIM3->CR1, 2, 5, value);
}
void STM32446Tim3_set_dir(uint8_t state)
{
	set_reg_block(&TIM3->CR1, 1, 4, state);
}
void STM32446Tim3_set_opm(uint8_t state)
{
	set_reg_block(&TIM3->CR1, 1, 3, state);
}
void STM32446Tim3_set_urs(uint8_t state)
{
	set_reg_block(&TIM3->CR1, 1, 2, state);
}
void STM32446Tim3_set_udis(uint8_t state)
{
	set_reg_block(&TIM3->CR1, 1, 1, state);
}
void STM32446Tim3_cen(uint8_t state)
{
	set_reg_block(&TIM3->CR1, 1, 0, state);
}
// CR2
void STM32446Tim3_ti1s(uint8_t state)
{
	set_reg_block(&TIM3->CR2, 1, 7, state);
}
void STM32446Tim3_mms(uint8_t value)
{
	set_reg_block(&TIM3->CR2, 3, 4, value);
}
void STM32446Tim3_ccds(uint8_t state)
{
	set_reg_block(&TIM3->CR2, 1, 3, state);
}
// SMCR
void STM32446Tim3_etp(uint8_t state)
{
	set_reg_block(&TIM3->SMCR, 1, 15, state);
}
void STM32446Tim3_ece(uint8_t state)
{
	set_reg_block(&TIM3->SMCR, 1, 14, state);
}
void STM32446Tim3_etps(uint8_t value)
{
	set_reg_block(&TIM3->SMCR, 2, 12, value);
}
void STM32446Tim3_etf(uint8_t value)
{
	set_reg_block(&TIM3->SMCR, 4, 8, value);
}
void STM32446Tim3_msm(uint8_t state)
{
	set_reg_block(&TIM3->SMCR, 1, 7, state);
}
void STM32446Tim3_ts(uint8_t value)
{
	set_reg_block(&TIM3->SMCR, 3, 4, value);
}
void STM32446Tim3_sms(uint8_t value)
{
	set_reg_block(&TIM3->SMCR, 3, 0, value);
}
// DIER
void STM32446Tim3_tde(uint8_t state)
{
	set_reg_block(&TIM3->DIER, 1, 14, state);
}
void STM32446Tim3_cc4de(uint8_t state)
{
	set_reg_block(&TIM3->DIER, 1, 12, state);
}
void STM32446Tim3_cc3de(uint8_t state)
{
	set_reg_block(&TIM3->DIER, 1, 11, state);
}
void STM32446Tim3_cc2de(uint8_t state)
{
	set_reg_block(&TIM3->DIER, 1, 10, state);
}
void STM32446Tim3_cc1de(uint8_t state)
{
	set_reg_block(&TIM3->DIER, 1, 9, state);
}
void STM32446Tim3_ude(uint8_t state)
{
	set_reg_block(&TIM3->DIER, 1, 8, state);
}
void STM32446Tim3_tie(uint8_t state)
{
	set_reg_block(&TIM3->DIER, 1, 6, state);
}
void STM32446Tim3_cc4ie(uint8_t state)
{
	set_reg_block(&TIM3->DIER, 1, 4, state);
}
void STM32446Tim3_cc3ie(uint8_t state)
{
	set_reg_block(&TIM3->DIER, 1, 3, state);
}
void STM32446Tim3_cc2ie(uint8_t state)
{
	set_reg_block(&TIM3->DIER, 1, 2, state);
}
void STM32446Tim3_cc1ie(uint8_t state)
{
	set_reg_block(&TIM3->DIER, 1, 1, state);
}
void STM32446Tim3_uie(uint8_t state)
{
	set_reg_block(&TIM3->DIER, 1, 0, state);
}
// SR
uint8_t STM32446Tim3_cc4of(void)
{
	return get_reg_block(TIM3->SR, 1, 12);
}
void STM32446Tim3_clear_cc4of(void)
{
	set_reg_block(&TIM3->SR, 1, 12, 0);
}
uint8_t STM32446Tim3_cc3of(void)
{
	return get_reg_block(TIM3->SR, 1, 11);
}
void STM32446Tim3_clear_cc3of(void)
{
	set_reg_block(&TIM3->SR, 1, 11, 0);
}
uint8_t STM32446Tim3_cc2of(void)
{
	return get_reg_block(TIM3->SR, 1, 10);
}
void STM32446Tim3_clear_cc2of(void)
{
	set_reg_block(&TIM3->SR, 1, 10, 0);
}
uint8_t STM32446Tim3_cc1of(void)
{
	return get_reg_block(TIM3->SR, 1, 9);
}
void STM32446Tim3_clear_cc1of(void)
{
	set_reg_block(&TIM3->SR, 1, 9, 0);
}
uint8_t STM32446Tim3_tif(void)
{
	return get_reg_block(TIM3->SR, 1, 6);
}
void STM32446Tim3_clear_tif(void)
{
	set_reg_block(&TIM3->SR, 1, 6, 0);
}
uint8_t STM32446Tim3_cc4if(void)
{
	return get_reg_block(TIM3->SR, 1, 4);
}
void STM32446Tim3_clear_cc4if(void)
{
	set_reg_block(&TIM3->SR, 1, 4, 0);
}
uint8_t STM32446Tim3_cc3if(void)
{
	return get_reg_block(TIM3->SR, 1, 3);
}
void STM32446Tim3_clear_cc3if(void)
{
	set_reg_block(&TIM3->SR, 1, 3, 0);
}
uint8_t STM32446Tim3_cc2if(void)
{
	return get_reg_block(TIM3->SR, 1, 2);
}
void STM32446Tim3_clear_cc2if(void)
{
	set_reg_block(&TIM3->SR, 1, 2, 0);
}
uint8_t STM32446Tim3_cc1if(void)
{
	return get_reg_block(TIM3->SR, 1, 1);
}
void STM32446Tim3_clear_cc1if(void)
{
	set_reg_block(&TIM3->SR, 1, 1, 0);
}
uint8_t STM32446Tim3_uif(void)
{
	return get_reg_block(TIM3->SR, 1, 0);
}
void STM32446Tim3_clear_uif(void)
{
	set_reg_block(&TIM3->SR, 1, 0, 0);
}
// EGR
void STM32446Tim3_tg(void)
{
	set_reg_block(&TIM3->EGR, 1, 6, 1);
}
void STM32446Tim3_cc4g(void)
{
	set_reg_block(&TIM3->EGR, 1, 4, 1);
}
void STM32446Tim3_cc3g(void)
{
	set_reg_block(&TIM3->EGR, 1, 3, 1);
}
void STM32446Tim3_cc2g(void)
{
	set_reg_block(&TIM3->EGR, 1, 2, 1);
}
void STM32446Tim3_cc1g(void)
{
	set_reg_block(&TIM3->EGR, 1, 1, 1);
}
void STM32446Tim3_ug(void)
{
	set_reg_block(&TIM3->EGR, 1, 0, 1);
}
// CCMR1
void STM32446Tim3_oc2ce(uint8_t value)
{
	set_reg_block(&TIM3->CCMR1, 1, 15, value);
}
void STM32446Tim3_oc2m(uint8_t value)
{
	set_reg_block(&TIM3->CCMR1, 3, 12, value);
}
void STM32446Tim3_ic2f(uint8_t value)
{
	set_reg_block(&TIM3->CCMR1, 4, 12, value);
}
void STM32446Tim3_oc2pe(uint8_t state)
{
	set_reg_block(&TIM3->CCMR1, 1, 11, state);
}
void STM32446Tim3_oc2fe(uint8_t state)
{
	set_reg_block(&TIM3->CCMR1, 1, 10, state);
}
void STM32446Tim3_ic2psc(uint8_t value)
{
	set_reg_block(&TIM3->CCMR1, 2, 10, value);
}
void STM32446Tim3_cc2s(uint8_t value)
{
	set_reg_block(&TIM3->CCMR1, 2, 8, value);
}
void STM32446Tim3_oc1ce(uint8_t value)
{
	set_reg_block(&TIM3->CCMR1, 1, 7, value);
}
void STM32446Tim3_oc1m(uint8_t value)
{
	set_reg_block(&TIM3->CCMR1, 3, 4, value);
}
void STM32446Tim3_ic1f(uint8_t value)
{
	set_reg_block(&TIM3->CCMR1, 4, 4, value);
}
void STM32446Tim3_oc1pe(uint8_t state)
{
	set_reg_block(&TIM3->CCMR1, 1, 3, state);
}
void STM32446Tim3_oc1fe(uint8_t state)
{
	set_reg_block(&TIM3->CCMR1, 1, 2, state);
}
void STM32446Tim3_ic1psc(uint8_t value)
{
	set_reg_block(&TIM3->CCMR1, 2, 2, value);
}
void STM32446Tim3_cc1s(uint8_t value)
{
	set_reg_block(&TIM3->CCMR1, 2, 0, value);
}
// CCMR2
void STM32446Tim3_oc4ce(uint8_t value)
{
	set_reg_block(&TIM3->CCMR2, 1, 15, value);
}
void STM32446Tim3_oc4m(uint8_t value)
{
	set_reg_block(&TIM3->CCMR2, 3, 12, value);
}
void STM32446Tim3_ic4f(uint8_t value)
{
	set_reg_block(&TIM3->CCMR2, 4, 12, value);
}
void STM32446Tim3_oc4pe(uint8_t state)
{
	set_reg_block(&TIM3->CCMR2, 1, 11, state);
}
void STM32446Tim3_oc4fe(uint8_t state)
{
	set_reg_block(&TIM3->CCMR2, 1, 10, state);
}
void STM32446Tim3_ic4psc(uint8_t value)
{
	set_reg_block(&TIM3->CCMR2, 2, 10, value);
}
void STM32446Tim3_cc4s(uint8_t value)
{
	set_reg_block(&TIM3->CCMR2, 2, 8, value);
}
void STM32446Tim3_oc3ce(uint8_t value)
{
	set_reg_block(&TIM3->CCMR2, 1, 7, value);
}
void STM32446Tim3_oc3m(uint8_t value)
{
	set_reg_block(&TIM3->CCMR2, 3, 4, value);
}
void STM32446Tim3_ic3f(uint8_t value)
{
	set_reg_block(&TIM3->CCMR2, 4, 4, value);
}
void STM32446Tim3_oc3pe(uint8_t state)
{
	set_reg_block(&TIM3->CCMR2, 1, 3, state);
}
void STM32446Tim3_oc3fe(uint8_t state)
{
	set_reg_block(&TIM3->CCMR2, 1, 2, state);
}
void STM32446Tim3_ic3psc(uint8_t value)
{
	set_reg_block(&TIM3->CCMR2, 2, 2, value);
}
void STM32446Tim3_cc3s(uint8_t value)
{
	set_reg_block(&TIM3->CCMR2, 2, 0, value);
}
// CCER
void STM32446Tim3_cc4np(uint8_t state)
{
	set_reg_block(&TIM3->CCER, 1, 15, state);
}
void STM32446Tim3_cc4p(uint8_t state)
{
	set_reg_block(&TIM3->CCER, 1, 13, state);
}
void STM32446Tim3_cc4e(uint8_t state)
{
	set_reg_block(&TIM3->CCER, 1, 12, state);
}
void STM32446Tim3_cc3np(uint8_t state)
{
	set_reg_block(&TIM3->CCER, 1, 11, state);
}
void STM32446Tim3_cc3p(uint8_t state)
{
	set_reg_block(&TIM3->CCER, 1, 9, state);
}
void STM32446Tim3_cc3e(uint8_t state)
{
	set_reg_block(&TIM3->CCER, 1, 8, state);
}
void STM32446Tim3_cc2np(uint8_t state)
{
	set_reg_block(&TIM3->CCER, 1, 7, state);
}
void STM32446Tim3_cc2p(uint8_t state)
{
	set_reg_block(&TIM3->CCER, 1, 5, state);
}
void STM32446Tim3_cc2e(uint8_t state)
{
	set_reg_block(&TIM3->CCER, 1, 4, state);
}
void STM32446Tim3_cc1np(uint8_t state)
{
	set_reg_block(&TIM3->CCER, 1, 3, state);
}
void STM32446Tim3_cc1p(uint8_t state)
{
	set_reg_block(&TIM3->CCER, 1, 1, state);
}
void STM32446Tim3_cc1e(uint8_t state)
{
	set_reg_block(&TIM3->CCER, 1, 0, state);
}
// CNT
...
{
	set_reg_block(&TIM3->DCR, 5, 8, value);
}
void STM32446Tim3_dba(uint8_t value)
{
	set_reg_block(&TIM3->DCR, 5, 0, value);
}
// DMAR
...
/*** TIM4 ***/
/************/
void STM32446Tim4Clock(uint8_t state)
{
	if(state){RCC->APB1ENR |= (1 << 2);}else{RCC->APB1ENR &= ~(1 << 2);}
}
void STM32446Tim4Nvic(uint8_t state)
{ // 30
...
{
	return get_reg_block(TIM4->CR1, 2, 8);
}
void STM32446Tim4_set_apre(uint8_t state)
{
	set_reg_block(&TIM4->CR1, 1, 7, state);
}
void STM32446Tim4_set_cms(uint8_t value)
{
	set_reg_block(&TIM4->CR1, 2, 5, value);
}
void STM32446Tim4_set_dir(uint8_t state)
{
	set_reg_block(&TIM4->CR1, 1, 4, state);
}
void STM32446Tim4_set_opm(uint8_t state)
{
	set_reg_block(&TIM4->CR1, 1, 3, state);
}
void STM32446Tim4_set_urs(uint8_t state)
{
	set_reg_block(&TIM4->CR1, 1, 2, state);
}
void STM32446Tim4_set_udis(uint8_t state)
{
	set_reg_block(&TIM4->CR1, 1, 1, state);
}
void STM32446Tim4_cen(uint8_t state)
{
	set_reg_block(&TIM4->CR1, 1, 0, state);
}
// CR2
void STM32446Tim4_ti1s(uint8_t state)
{
	set_reg_block(&TIM4->CR2, 1, 7, state);
}
void STM32446Tim4_mms(uint8_t value)
{
	set_reg_block(&TIM4->CR2, 3, 4, value);
}
void STM32446Tim4_ccds(uint8_t state)
{
	set_reg_block(&TIM4->CR2, 1, 3, state);
}
// SMCR
void STM32446Tim4_etp(uint8_t state)
{
	set_reg_block(&TIM4->SMCR, 1, 15, state);
}
void STM32446Tim4_ece(uint8_t state)
{
	set_reg_block(&TIM4->SMCR, 1, 14, state);
}
void STM32446Tim4_etps(uint8_t value)
{
	set_reg_block(&TIM4->SMCR, 2, 12, value);
}
void STM32446Tim4_etf(uint8_t value)
{
	set_reg_block(&TIM4->SMCR, 4, 8, value);
}
void STM32446Tim4_msm(uint8_t state)
{
	set_reg_block(&TIM4->SMCR, 1, 7, state);
}
void STM32446Tim4_ts(uint8_t value)
{
	set_reg_block(&TIM4->SMCR, 3, 4, value);
}
void STM32446Tim4_sms(uint8_t value)
{
	set_reg_block(&TIM4->SMCR, 3, 0, value);
}
// DIER
void STM32446Tim4_tde(uint8_t state)
{
	set_reg_block(&TIM4->DIER, 1, 14, state);
}
void STM32446Tim4_cc4de(uint8_t state)
{
	set_reg_block(&TIM4->DIER, 1, 12, state);
}
void STM32446Tim4_cc3de(uint8_t state)
{
	set_reg_block(&TIM4->DIER, 1, 11, state);
}
void STM32446Tim4_cc2de(uint8_t state)
{
	set_reg_block(&TIM4->DIER, 1, 10, state);
}
void STM32446Tim4_cc1de(uint8_t state)
{
	set_reg_block(&TIM4->DIER, 1, 9, state);
}
void STM32446Tim4_ude(uint8_t state)
{
	set_reg_block(&TIM4->DIER, 1, 8, state);
}
void STM32446Tim4_tie(uint8_t state)
{
	set_reg_block(&TIM4->DIER, 1, 6, state);
}
void STM32446Tim4_cc4ie(uint8_t state)
{
	set_reg_block(&TIM4->DIER, 1, 4, state);
}
void STM32446Tim4_cc3ie(uint8_t state)
{
	set_reg_block(&TIM4->DIER, 1, 3, state);
}
void STM32446Tim4_cc2ie(uint8_t state)
{
	set_reg_block(&TIM4->DIER, 1, 2, state);
}
void STM32446Tim4_cc1ie(uint8_t state)
{
	set_reg_block(&TIM4->DIER, 1, 1, state);
}
void STM32446Tim4_uie(uint8_t state)
{
	set_reg_block(&TIM4->DIER, 1, 0, state);
}
// SR
uint8_t STM32446Tim4_cc4of(void)
{
	return get_reg_block(TIM4->SR, 1, 12);
}
void STM32446Tim4_clear_cc4of(void)
{
	set_reg_block(&TIM4->SR, 1, 12, 0);
}
uint8_t STM32446Tim4_cc3of(void)
{
	return get_reg_block(TIM4->SR, 1, 11);
}
void STM32446Tim4_clear_cc3of(void)
{
	set_reg_block(&TIM4->SR, 1, 11, 0);
}
uint8_t STM32446Tim4_cc2of(void)
{
	return get_reg_block(TIM4->SR, 1, 10);
}
void STM32446Tim4_clear_cc2of(void)
{
	set_reg_block(&TIM4->SR, 1, 10, 0);
}
uint8_t STM32446Tim4_cc1of(void)
{
	return get_reg_block(TIM4->SR, 1, 9);
}
void STM32446Tim4_clear_cc1of(void)
{
	set_reg_block(&TIM4->SR, 1, 9, 0);
}
uint8_t STM32446Tim4_tif(void)
{
	return get_reg_block(TIM4->SR, 1, 6);
}
void STM32446Tim4_clear_tif(void)
{
	set_reg_block(&TIM4->SR, 1, 6, 0);
}
uint8_t STM32446Tim4_cc4if(void)
{
	return get_reg_block(TIM4->SR, 1, 4);
}
void STM32446Tim4_clear_cc4if(void)
{
	set_reg_block(&TIM4->SR, 1, 4, 0);
}
uint8_t STM32446Tim4_cc3if(void)
{
	return get_reg_block(TIM4->SR, 1, 3);
}
void STM32446Tim4_clear_cc3if(void)
{
	set_reg_block(&TIM4->SR, 1, 3, 0);
}
uint8_t STM32446Tim4_cc2if(void)
{
	return get_reg_block(TIM4->SR, 1, 2);
}
void STM32446Tim4_clear_cc2if(void)
{
	set_reg_block(&TIM4->SR, 1, 2, 0);
}
uint8_t STM32446Tim4_cc1if(void)
{
	return get_reg_block(TIM4->SR, 1, 1);
}
void STM32446Tim4_clear_cc1if(void)
{
	set_reg_block(&TIM4->SR, 1, 1, 0);
}
uint8_t STM32446Tim4_uif(void)
{
	return get_reg_block(TIM4->SR, 1, 0);
}
void STM32446Tim4_clear_uif(void)
{
	set_reg_block(&TIM4->SR, 1, 0, 0);
}
// EGR
void STM32446Tim4_tg(void)
{
	set_reg_block(&TIM4->EGR, 1, 6, 1);
}
void STM32446Tim4_cc4g(void)
{
	set_reg_block(&TIM4->EGR, 1, 4, 1);
}
void STM32446Tim4_cc3g(void)
{
	set_reg_block(&TIM4->EGR, 1, 3, 1);
}
void STM32446Tim4_cc2g(void)
{
	set_reg_block(&TIM4->EGR, 1, 2, 1);
}
void STM32446Tim4_cc1g(void)
{
	set_reg_block(&TIM4->EGR, 1, 1, 1);
}
void STM32446Tim4_ug(void)
{
	set_reg_block(&TIM4->EGR, 1, 0, 1);
}
// CCMR1
void STM32446Tim4_oc2ce(uint8_t value)
{
	set_reg_block(&TIM4->CCMR1, 1, 15, value);
}
void STM32446Tim4_oc2m(uint8_t value)
{
	set_reg_block(&TIM4->CCMR1, 3, 12, value);
}
void STM32446Tim4_ic2f(uint8_t value)
{
	set_reg_block(&TIM4->CCMR1, 4, 12, value);
}
void STM32446Tim4_oc2pe(uint8_t state)
{
	set_reg_block(&TIM4->CCMR1, 1, 11, state);
}
void STM32446Tim4_oc2fe(uint8_t state)
{
	set_reg_block(&TIM4->CCMR1, 1, 10, state);
}
void STM32446Tim4_ic2psc(uint8_t value)
{
	set_reg_block(&TIM4->CCMR1, 2, 10, value);
}
void STM32446Tim4_cc2s(uint8_t value)
{
	set_reg_block(&TIM4->CCMR1, 2, 8, value);
}
void STM32446Tim4_oc1ce(uint8_t value)
{
	set_reg_block(&TIM4->CCMR1, 1, 7, value);
}
void STM32446Tim4_oc1m(uint8_t value)
{
	set_reg_block(&TIM4->CCMR1, 3, 4, value);
}
void STM32446Tim4_ic1f(uint8_t value)
{
	set_reg_block(&TIM4->CCMR1, 4, 4, value);
}
void STM32446Tim4_oc1pe(uint8_t state)
{
	set_reg_block(&TIM4->CCMR1, 1, 3, state);
}
void STM32446Tim4_oc1fe(uint8_t state)
{
	set_reg_block(&TIM4->CCMR1, 1, 2, state);
}
void STM32446Tim4_ic1psc(uint8_t value)
{
	set_reg_block(&TIM4->CCMR1, 2, 2, value);
}
void STM32446Tim4_cc1s(uint8_t value)
{
	set_reg_block(&TIM4->CCMR1, 2, 0, value);
}
// CCMR2
void STM32446Tim4_oc4ce(uint8_t value)
{
	set_reg_block(&TIM4->CCMR2, 1, 15, value);
}
void STM32446Tim4_oc4m(uint8_t value)
{
	set_reg_block(&TIM4->CCMR2, 3, 12, value);
}
void STM32446Tim4_ic4f(uint8_t value)
{
	set_reg_block(&TIM4->CCMR2, 4, 12, value);
}
void STM32446Tim4_oc4pe(uint8_t state)
{
	set_reg_block(&TIM4->CCMR2, 1, 11, state);
}
void STM32446Tim4_oc4fe(uint8_t state)
{
	set_reg_block(&TIM4->CCMR2, 1, 10, state);
}
void STM32446Tim4_ic4psc(uint8_t value)
{
	set_reg_block(&TIM4->CCMR2, 2, 10, value);
}
void STM32446Tim4_cc4s(uint8_t value)
{
	set_reg_block(&TIM4->CCMR2, 2, 8, value);
}
void STM32446Tim4_oc3ce(uint8_t value)
{
	set_reg_block(&TIM4->CCMR2, 1, 7, value);
}
void STM32446Tim4_oc3m(uint8_t value)
{
	set_reg_block(&TIM4->CCMR2, 3, 4, value);
}
void STM32446Tim4_ic3f(uint8_t value)
{
	set_reg_block(&TIM4->CCMR2, 4, 4, value);
}
void STM32446Tim4_oc3pe(uint8_t state)
{
	set_reg_block(&TIM4->CCMR2, 1, 3, state);
}
void STM32446Tim4_oc3fe(uint8_t state)
{
	set_reg_block(&TIM4->CCMR2, 1, 2, state);
}
void STM32446Tim4_ic3psc(uint8_t value)
{
	set_reg_block(&TIM4->CCMR2, 2, 2, value);
}
void STM32446Tim4_cc3s(uint8_t value)
{
	set_reg_block(&TIM4->CCMR2, 2, 0, value);
}
// CCER
void STM32446Tim4_cc4np(uint8_t state)
{
	set_reg_block(&TIM4->CCER, 1, 15, state);
}
void STM32446Tim4_cc4p(uint8_t state)
{
	set_reg_block(&TIM4->CCER, 1, 13, state);
}
void STM32446Tim4_cc4e(uint8_t state)
{
	set_reg_block(&TIM4->CCER, 1, 12, state);
}
void STM32446Tim4_cc3np(uint8_t state)
{
	set_reg_block(&TIM4->CCER, 1, 11, state);
}
void STM32446Tim4_cc3p(uint8_t state)
{
	set_reg_block(&TIM4->CCER, 1, 9, state);
}
void STM32446Tim4_cc3e(uint8_t state)
{
	set_reg_block(&TIM4->CCER, 1, 8, state);
}
void STM32446Tim4_cc2np(uint8_t state)
{
	set_reg_block(&TIM4->CCER, 1, 7, state);
}
void STM32446Tim4_cc2p(uint8_t state)
{
	set_reg_block(&TIM4->CCER, 1, 5, state);
}
void STM32446Tim4_cc2e(uint8_t state)
{
	set_reg_block(&TIM4->CCER, 1, 4, state);
}
void STM32446Tim4_cc1np(uint8_t state)
{
	set_reg_block(&TIM4->CCER, 1, 3, state);
}
void STM32446Tim4_cc1p(uint8_t state)
{
	set_reg_block(&TIM4->CCER, 1, 1, state);
}
void STM32446Tim4_cc1e(uint8_t state)
{
	set_reg_block(&TIM4->CCER, 1, 0, state);
}
// CNT
...
{
	set_reg_block(&TIM4->DCR, 5, 8, value);
}
void STM32446Tim4_dba(uint8_t value)
{
	set_reg_block(&TIM4->DCR, 5, 0, value);
}
// DMAR
...
/*** TIM5 ***/
/************/
void STM32446Tim5Clock(uint8_t state)
{
	if(state){RCC->APB1ENR |= (1 << 3);}else{RCC->APB1ENR &= ~(1 << 3);}
}
void STM32446Tim5Nvic(uint8_t state)
{ // 50
...
{
	return get_reg_block(TIM5->CR1, 2, 8);
}
void STM32446Tim5_set_apre(uint8_t state)
{
	set_reg_block(&TIM5->CR1, 1, 7, state);
}
void STM32446Tim5_set_cms(uint8_t value)
{
	set_reg_block(&TIM5->CR1, 2, 5, value);
}
void STM32446Tim5_set_dir(uint8_t state)
{
	set_reg_block(&TIM5->CR1, 1, 4, state);
}
void STM32446Tim5_set_opm(uint8_t state)
{
	set_reg_block(&TIM5->CR1, 1, 3, state);
}
void STM32446Tim5_set_urs(uint8_t state)
{
	set_reg_block(&TIM5->CR1, 1, 2, state);
}
void STM32446Tim5_set_udis(uint8_t state)
{
	set_reg_block(&TIM5->CR1, 1, 1, state);
}
void STM32446Tim5_cen(uint8_t state)
{
	set_reg_block(&TIM5->CR1, 1, 0, state);
}
// CR2
void STM32446Tim5_ti1s(uint8_t state)
{
	set_reg_block(&TIM5->CR2, 1, 7, state);
}
void STM32446Tim5_mms(uint8_t value)
{
	set_reg_block(&TIM5->CR2, 3, 4, value);
}
void STM32446Tim5_ccds(uint8_t state)
{
	set_reg_block(&TIM5->CR2, 1, 3, state);
}
// SMCR
void STM32446Tim5_etp(uint8_t state)
{
	set_reg_block(&TIM5->SMCR, 1, 15, state);
}
void STM32446Tim5_ece(uint8_t state)
{
	set_reg_block(&TIM5->SMCR, 1, 14, state);
}
void STM32446Tim5_etps(uint8_t value)
{
	set_reg_block(&TIM5->SMCR, 2, 12, value);
}
void STM32446Tim5_etf(uint8_t value)
{
	set_reg_block(&TIM5->SMCR, 4, 8, value);
}
void STM32446Tim5_msm(uint8_t state)
{
	set_reg_block(&TIM5->SMCR, 1, 7, state);
}
void STM32446Tim5_ts(uint8_t value)
{
	set_reg_block(&TIM5->SMCR, 3, 4, value);
}
void STM32446Tim5_sms(uint8_t value)
{
	set_reg_block(&TIM5->SMCR, 3, 0, value);
}
// DIER
void STM32446Tim5_tde(uint8_t state)
{
	set_reg_block(&TIM5->DIER, 1, 14, state);
}
void STM32446Tim5_cc4de(uint8_t state)
{
	set_reg_block(&TIM5->DIER, 1, 12, state);
}
void STM32446Tim5_cc3de(uint8_t state)
{
	set_reg_block(&TIM5->DIER, 1, 11, state);
}
void STM32446Tim5_cc2de(uint8_t state)
{
	set_reg_block(&TIM5->DIER, 1, 10, state);
}
void STM32446Tim5_cc1de(uint8_t state)
{
	set_reg_block(&TIM5->DIER, 1, 9, state);
}
void STM32446Tim5_ude(uint8_t state)
{
	set_reg_block(&TIM5->DIER, 1, 8, state);
}
void STM32446Tim5_tie(uint8_t state)
{
	set_reg_block(&TIM5->DIER, 1, 6, state);
}
void STM32446Tim5_cc4ie(uint8_t state)
{
	set_reg_block(&TIM5->DIER, 1, 4, state);
}
void STM32446Tim5_cc3ie(uint8_t state)
{
	set_reg_block(&TIM5->DIER, 1, 3, state);
}
void STM32446Tim5_cc2ie(uint8_t state)
{
	set_reg_block(&TIM5->DIER, 1, 2, state);
}
void STM32446Tim5_cc1ie(uint8_t state)
{
	set_reg_block(&TIM5->DIER, 1, 1, state);
}
void STM32446Tim5_uie(uint8_t state)
{
	set_reg_block(&TIM5->DIER, 1, 0, state);
}
// SR
uint8_t STM32446Tim5_cc4of(void)
{
	return get_reg_block(TIM5->SR, 1, 12);
}
void STM32446Tim5_clear_cc4of(void)
{
	set_reg_block(&TIM5->SR, 1, 12, 0);
}
uint8_t STM32446Tim5_cc3of(void)
{
	return get_reg_block(TIM5->SR, 1, 11);
}
void STM32446Tim5_clear_cc3of(void)
{
	set_reg_block(&TIM5->SR, 1, 11, 0);
}
uint8_t STM32446Tim5_cc2of(void)
{
	return get_reg_block(TIM5->SR, 1, 10);
}
void STM32446Tim5_clear_cc2of(void)
{
	set_reg_block(&TIM5->SR, 1, 10, 0);
}
uint8_t STM32446Tim5_cc1of(void)
{
	return get_reg_block(TIM5->SR, 1, 9);
}
void STM32446Tim5_clear_cc1of(void)
{
	set_reg_block(&TIM5->SR, 1, 9, 0);
}
uint8_t STM32446Tim5_tif(void)
{
	return get_reg_block(TIM5->SR, 1, 6);
}
void STM32446Tim5_clear_tif(void)
{
	set_reg_block(&TIM5->SR, 1, 6, 0);
}
uint8_t STM32446Tim5_cc4if(void)
{
	return get_reg_block(TIM5->SR, 1, 4);
}
void STM32446Tim5_clear_cc4if(void)
{
	set_reg_block(&TIM5->SR, 1, 4, 0);
}
uint8_t STM32446Tim5_cc3if(void)
{
	return get_reg_block(TIM5->SR, 1, 3);
}
void STM32446Tim5_clear_cc3if(void)
{
	set_reg_block(&TIM5->SR, 1, 3, 0);
}
uint8_t STM32446Tim5_cc2if(void)
{
	return get_reg_block(TIM5->SR, 1, 2);
}
void STM32446Tim5_clear_cc2if(void)
{
	set_reg_block(&TIM5->SR, 1, 2, 0);
}
uint8_t STM32446Tim5_cc1if(void)
{
	return get_reg_block(TIM5->SR, 1, 1);
}
void STM32446Tim5_clear_cc1if(void)
{
	set_reg_block(&TIM5->SR, 1, 1, 0);
}
uint8_t STM32446Tim5_uif(void)
{
	return get_reg_block(TIM5->SR, 1, 0);
}
void STM32446Tim5_clear_uif(void)
{
	set_reg_block(&TIM5->SR, 1, 0, 0);
}
// EGR
void STM32446Tim5_tg(void)
{
	set_reg_block(&TIM5->EGR, 1, 6, 1);
}
void STM32446Tim5_cc4g(void)
{
	set_reg_block(&TIM5->EGR, 1, 4, 1);
}
void STM32446Tim5_cc3g(void)
{
	set_reg_block(&TIM5->EGR, 1, 3, 1);
}
void STM32446Tim5_cc2g(void)
{
	set_reg_block(&TIM5->EGR, 1, 2, 1);
}
void STM32446Tim5_cc1g(void)
{
	set_reg_block(&TIM5->EGR, 1, 1, 1);
}
void STM32446Tim5_ug(void)
{
	set_reg_block(&TIM5->EGR, 1, 0, 1);
}
// CCMR1
void STM32446Tim5_oc2ce(uint8_t value)
{
	set_reg_block(&TIM5->CCMR1, 1, 15, value);
}
void STM32446Tim5_oc2m(uint8_t value)
{
	set_reg_block(&TIM5->CCMR1, 3, 12, value);
}
void STM32446Tim5_ic2f(uint8_t value)
{
	set_reg_block(&TIM5->CCMR1, 4, 12, value);
}
void STM32446Tim5_oc2pe(uint8_t state)
{
	set_reg_block(&TIM5->CCMR1, 1, 11, state);
}
void STM32446Tim5_oc2fe(uint8_t state)
{
	set_reg_block(&TIM5->CCMR1, 1, 10, state);
}
void STM32446Tim5_ic2psc(uint8_t value)
{
	set_reg_block(&TIM5->CCMR1, 2, 10, value);
}
void STM32446Tim5_cc2s(uint8_t value)
{
	set_reg_block(&TIM5->CCMR1, 2, 8, value);
}
void STM32446Tim5_oc1ce(uint8_t value)
{
	set_reg_block(&TIM5->CCMR1, 1, 7, value);
}
void STM32446Tim5_oc1m(uint8_t value)
{
	set_reg_block(&TIM5->CCMR1, 3, 4, value);
}
void STM32446Tim5_ic1f(uint8_t value)
{
	set_reg_block(&TIM5->CCMR1, 4, 4, value);
}
void STM32446Tim5_oc1pe(uint8_t state)
{
	set_reg_block(&TIM5->CCMR1, 1, 3, state);
}
void STM32446Tim5_oc1fe(uint8_t state)
{
	set_reg_block(&TIM5->CCMR1, 1, 2, state);
}
void STM32446Tim5_ic1psc(uint8_t value)
{
	set_reg_block(&TIM5->CCMR1, 2, 2, value);
}
void STM32446Tim5_cc1s(uint8_t value)
{
	set_reg_block(&TIM5->CCMR1, 2, 0, value);
}
// CCMR2
void STM32446Tim5_oc4ce(uint8_t value)
{
	set_reg_block(&TIM5->CCMR2, 1, 15, value);
}
void STM32446Tim5_oc4m(uint8_t value)
{
	set_reg_block(&TIM5->CCMR2, 3, 12, value);
}
void STM32446Tim5_ic4f(uint8_t value)
{
	set_reg_block(&TIM5->CCMR2, 4, 12, value);
}
void STM32446Tim5_oc4pe(uint8_t state)
{
	set_reg_block(&TIM5->CCMR2, 1, 11, state);
}
void STM32446Tim5_oc4fe(uint8_t state)
{
	set_reg_block(&TIM5->CCMR2, 1, 10, state);
}
void STM32446Tim5_ic4psc(uint8_t value)
{
	set_reg_block(&TIM5->CCMR2, 2, 10, value);
}
void STM32446Tim5_cc4s(uint8_t value)
{
	set_reg_block(&TIM5->CCMR2, 2, 8, value);
}
void STM32446Tim5_oc3ce(uint8_t value)
{
	set_reg_block(&TIM5->CCMR2, 1, 7, value);
}
void STM32446Tim5_oc3m(uint8_t value)
{
	set_reg_block(&TIM5->CCMR2, 3, 4, value);
}
void STM32446Tim5_ic3f(uint8_t value)
{
	set_reg_block(&TIM5->CCMR2, 4, 4, value);
}
void STM32446Tim5_oc3pe(uint8_t state)
{
	set_reg_block(&TIM5->CCMR2, 1, 3, state);
}
void STM32446Tim5_oc3fe(uint8_t state)
{
	set_reg_block(&TIM5->CCMR2, 1, 2, state);
}
void STM32446Tim5_ic3psc(uint8_t value)
{
	set_reg_block(&TIM5->CCMR2, 2, 2, value);
}
void STM32446Tim5_cc3s(uint8_t value)
{
	set_reg_block(&TIM5->CCMR2, 2, 0, value);
}
// CCER
void STM32446Tim5_cc4np(uint8_t state)
{
	set_reg_block(&TIM5->CCER, 1, 15, state);
}
void STM32446Tim5_cc4p(uint8_t state)
{
	set_reg_block(&TIM5->CCER, 1, 13, state);
}
void STM32446Tim5_cc4e(uint8_t state)
{
	set_reg_block(&TIM5->CCER, 1, 12, state);
}
void STM32446Tim5_cc3np(uint8_t state)
{
	set_reg_block(&TIM5->CCER, 1, 11, state);
}
void STM32446Tim5_cc3p(uint8_t state)
{
	set_reg_block(&TIM5->CCER, 1, 9, state);
}
void STM32446Tim5_cc3e(uint8_t state)
{
	set_reg_block(&TIM5->CCER, 1, 8, state);
}
void STM32446Tim5_cc2np(uint8_t state)
{
	set_reg_block(&TIM5->CCER, 1, 7, state);
}
void STM32446Tim5_cc2p(uint8_t state)
{
	set_reg_block(&TIM5->CCER, 1, 5, state);
}
void STM32446Tim5_cc2e(uint8_t state)
{
	set_reg_block(&TIM5->CCER, 1, 4, state);
}
void STM32446Tim5_cc1np(uint8_t state)
{
	set_reg_block(&TIM5->CCER, 1, 3, state);
}
void STM32446Tim5_cc1p(uint8_t state)
{
	set_reg_block(&TIM5->CCER, 1, 1, state);
}
void STM32446Tim5_cc1e(uint8_t state)
{
	set_reg_block(&TIM5->CCER, 1, 0, state);
}
// CNT
...
{
	set_reg_block(&TIM5->DCR, 5, 8, value);
}
void STM32446Tim5_dba(uint8_t value)
{
	set_reg_block(&TIM5->DCR, 5, 0, value);
}
// DMAR
...
{
	set_reg_block(&TIM5->OR, 2, 6, value);
}
/*** TIM2 Auxiliar ***/
STM32446TIM2_CR1* stm32446_tim2_cr1_inic(void)
{
