...
/*** File Variable ***/
static STM32446USART_SR stm32446_usart1_sr;
static STM32446USART_BRR stm32446_usart1_brr;
static STM32446USART_CR1 stm32446_usart1_cr1;
static STM32446USART_CR2 stm32446_usart1_cr2;
static STM32446USART_CR3 stm32446_usart1_cr3;
static STM32446USART_GTPR stm32446_usart1_gtpr;
static STM32446_USART1 stm32446_usart1;
static STM32446USART_SR stm32446_usart2_sr;
static STM32446USART_BRR stm32446_usart2_brr;
static STM32446USART_CR1 stm32446_usart2_cr1;
static STM32446USART_CR2 stm32446_usart2_cr2;
static STM32446USART_CR3 stm32446_usart2_cr3;
static STM32446USART_GTPR stm32446_usart2_gtpr;
static STM32446_USART2 stm32446_usart2;
static STM32446USART_SR stm32446_usart3_sr;
static STM32446USART_BRR stm32446_usart3_brr;
static STM32446USART_CR1 stm32446_usart3_cr1;
static STM32446USART_CR2 stm32446_usart3_cr2;
static STM32446USART_CR3 stm32446_usart3_cr3;
static STM32446USART_GTPR stm32446_usart3_gtpr;
static STM32446_USART3 stm32446_usart3;
static STM32446USART_SR stm32446_uart4_sr;
static STM32446USART_BRR stm32446_uart4_brr;
static STM32446USART_CR1 stm32446_uart4_cr1;
static STM32446USART_CR2 stm32446_uart4_cr2;
static STM32446USART_CR3 stm32446_uart4_cr3;
static STM32446USART_GTPR stm32446_uart4_gtpr;
static STM32446_UART4 stm32446_uart4;
static STM32446USART_SR stm32446_uart5_sr;
static STM32446USART_BRR stm32446_uart5_brr;
static STM32446USART_CR1 stm32446_uart5_cr1;
static STM32446USART_CR2 stm32446_uart5_cr2;
static STM32446USART_CR3 stm32446_uart5_cr3;
static STM32446USART_GTPR stm32446_uart5_gtpr;
static STM32446_UART5 stm32446_uart5;
static STM32446USART_SR stm32446_usart6_sr;
static STM32446USART_BRR stm32446_usart6_brr;
static STM32446USART_CR1 stm32446_usart6_cr1;
static STM32446USART_CR2 stm32446_usart6_cr2;
static STM32446USART_CR3 stm32446_usart6_cr3;
static STM32446USART_GTPR stm32446_usart6_gtpr;
...
/*** USART1 ***/
void STM32446Usart1Clock( uint8_t state )
{
	if(state){ RCC->APB2ENR |= (1 << 4); }else{ RCC->APB2ENR &= ~(1 << 4); }
}
void STM32446Usart1Nvic( uint8_t state )
{
...
{
	return get_reg_block(USART1->SR, 1, 9);
}
void STM32446Usart1_clear_cts(void)
{
	set_reg_block(&USART1->SR, 1, 9, 0);
}
uint8_t STM32446Usart1_lbd(void)
{
	return get_reg_block(USART1->SR, 1, 8);
}
void STM32446Usart1_clear_lbd(void)
{
	set_reg_block(&USART1->SR, 1, 8, 0);
}
uint8_t STM32446Usart1_txe(void)
{
	return get_reg_block(USART1->SR, 1, 7);
}
uint8_t STM32446Usart1_tc(void)
{
	return get_reg_block(USART1->SR, 1, 6);
}
void STM32446Usart1_clear_tc(void)
{
	set_reg_block(&USART1->SR, 1, 6, 0);
}
uint8_t STM32446Usart1_rxne(void)
{
	return get_reg_block(USART1->SR, 1, 5);
}
void STM32446Usart1_clear_rxne(void)
{
	set_reg_block(&USART1->SR, 1, 5, 0);
}
uint8_t STM32446Usart1_idle(void)
{
	return get_reg_block(USART1->SR, 1, 4);
}
uint8_t STM32446Usart1_ore(void)
{
	return get_reg_block(USART1->SR, 1, 3);
}
uint8_t STM32446Usart1_nf(void)
{
	return get_reg_block(USART1->SR, 1, 2);
}
uint8_t STM32446Usart1_fe(void)
{
	return get_reg_block(USART1->SR, 1, 1);
}
uint8_t STM32446Usart1_pe(void)
{
	return get_reg_block(USART1->SR, 1, 0);
}
// DR
void STM32446Usart1_dr(uint32_t data)
{
	write_reg_block(&USART1->DR, 9, 0, data);
}
uint32_t STM32446Usart1_get_dr(void)
{
	return get_reg_block(USART1->DR, 9, 0);
}
// BRR
void STM32446Usart1_div_mantissa(uint16_t value)
{
	set_reg_block(&USART1->BRR, 12, 4, value);
}
void STM32446Usart1_div_fraction(uint8_t value)
{
	set_reg_block(&USART1->BRR, 4, 0, value);
}
// CR1
void STM32446Usart1_over8(uint8_t state)
{
	set_reg_block(&USART1->CR1, 1, 15, state);
}
void STM32446Usart1_ue(uint8_t state)
{
	set_reg_block(&USART1->CR1, 1, 13, state);
}
void STM32446Usart1_m(uint8_t state)
{
	set_reg_block(&USART1->CR1, 1, 12, state);
}
void STM32446Usart1_wake(uint8_t state)
{
	set_reg_block(&USART1->CR1, 1, 11, state);
}
void STM32446Usart1_pce(uint8_t state)
{
	set_reg_block(&USART1->CR1, 1, 10, state);
}
void STM32446Usart1_ps(uint8_t state)
{
	set_reg_block(&USART1->CR1, 1, 9, state);
}
void STM32446Usart1_peie(uint8_t state)
{
	set_reg_block(&USART1->CR1, 1, 8, state);
}
void STM32446Usart1_txeie(uint8_t state)
{
	set_reg_block(&USART1->CR1, 1, 7, state);
}
void STM32446Usart1_tcie(uint8_t state)
{
	set_reg_block(&USART1->CR1, 1, 6, state);
}
void STM32446Usart1_rxneie(uint8_t state)
{
	set_reg_block(&USART1->CR1, 1, 5, state);
}
void STM32446Usart1_idleie(uint8_t state)
{
	set_reg_block(&USART1->CR1, 1, 4, state);
}
void STM32446Usart1_te(uint8_t state)
{
	set_reg_block(&USART1->CR1, 1, 3, state);
}
void STM32446Usart1_re(uint8_t state)
{
	set_reg_block(&USART1->CR1, 1, 2, state);
}
void STM32446Usart1_rwu(uint8_t state)
{
	set_reg_block(&USART1->CR1, 1, 1, state);
}
void STM32446Usart1_sbk(uint8_t state)
{
	set_reg_block(&USART1->CR1, 1, 0, state);
}
// CR2
void STM32446Usart1_linen(uint8_t state)
{
	set_reg_block(&USART1->CR2, 1, 14, state);
}
void STM32446Usart1_stop(uint8_t value)
{
	set_reg_block(&USART1->CR2, 2, 12, value);
}

void STM32446Usart1_clken(uint8_t state)
{
	set_reg_block(&USART1->CR2, 1, 11, state);
}
void STM32446Usart1_cpol(uint8_t state)
{
	set_reg_block(&USART1->CR2, 1, 10, state);
}
void STM32446Usart1_cpha(uint8_t state)
{
	set_reg_block(&USART1->CR2, 1, 9, state);
}
void STM32446Usart1_lbcl(uint8_t state)
{
	set_reg_block(&USART1->CR2, 1, 8, state);
}
void STM32446Usart1_lbdie(uint8_t state)
{
	set_reg_block(&USART1->CR2, 1, 6, state);
}
void STM32446Usart1_lbdl(uint8_t state)
{
	set_reg_block(&USART1->CR2, 1, 5, state);
}
void STM32446Usart1_add(uint8_t value)
{
	set_reg_block(&USART1->CR2, 4, 0, value);
}
// CR3
void STM32446Usart1_onebit(uint8_t state)
{
	set_reg_block(&USART1->CR3, 1, 11, state);
}
void STM32446Usart1_ctsie(uint8_t state)
{
	set_reg_block(&USART1->CR3, 1, 10, state);
}
void STM32446Usart1_ctse(uint8_t state)
{
	set_reg_block(&USART1->CR3, 1, 9, state);
}
void STM32446Usart1_rtse(uint8_t state)
{
	set_reg_block(&USART1->CR3, 1, 8, state);
}
void STM32446Usart1_dmat(uint8_t state)
{
	set_reg_block(&USART1->CR3, 1, 7, state);
}
void STM32446Usart1_dmar(uint8_t state)
{
	set_reg_block(&USART1->CR3, 1, 6, state);
}
void STM32446Usart1_scen(uint8_t state)
{
	set_reg_block(&USART1->CR3, 1, 5, state);
}
void STM32446Usart1_nack(uint8_t state)
{
	set_reg_block(&USART1->CR3, 1, 4, state);
}
void STM32446Usart1_hdsel(uint8_t state)
{
	set_reg_block(&USART1->CR3, 1, 3, state);
}
void STM32446Usart1_irlp(uint8_t state)
{
	set_reg_block(&USART1->CR3, 1, 2, state);
}
void STM32446Usart1_iren(uint8_t state)
{
	set_reg_block(&USART1->CR3, 1, 1, state);
}
void STM32446Usart1_eie(uint8_t state)
{
	set_reg_block(&USART1->CR3, 1, 0, state);
}
// GTPR
void STM32446Usart1_gt(uint8_t value)
{
	set_reg_block(&USART1->GTPR, 8, 8, value);
}
void STM32446Usart1_psc(uint8_t value)
{
	set_reg_block(&USART1->GTPR, 8, 0, value);
}
/*** USART2 ***/
void STM32446Usart2Clock( uint8_t state )
{
	if(state){ RCC->APB1ENR |= (1 << 17); }else{ RCC->APB1ENR &= ~(1 << 17); }
}
void STM32446Usart2Nvic( uint8_t state )
{
...
{
	return get_reg_block(USART2->SR, 1, 9);
}
void STM32446Usart2_clear_cts(void)
{
	set_reg_block(&USART2->SR, 1, 9, 0);
}
uint8_t STM32446Usart2_lbd(void)
{
	return get_reg_block(USART2->SR, 1, 8);
}
void STM32446Usart2_clear_lbd(void)
{
	set_reg_block(&USART2->SR, 1, 8, 0);
}
uint8_t STM32446Usart2_txe(void)
{
	return get_reg_block(USART2->SR, 1, 7);
}
uint8_t STM32446Usart2_tc(void)
{
	return get_reg_block(USART2->SR, 1, 6);
}
void STM32446Usart2_clear_tc(void)
{
	set_reg_block(&USART2->SR, 1, 6, 0);
}
uint8_t STM32446Usart2_rxne(void)
{
	return get_reg_block(USART2->SR, 1, 5);
}
void STM32446Usart2_clear_rxne(void)
{
	set_reg_block(&USART2->SR, 1, 5, 0);
}
uint8_t STM32446Usart2_idle(void)
{
	return get_reg_block(USART2->SR, 1, 4);
}
uint8_t STM32446Usart2_ore(void)
{
	return get_reg_block(USART2->SR, 1, 3);
}
uint8_t STM32446Usart2_nf(void)
{
	return get_reg_block(USART2->SR, 1, 2);
}
uint8_t STM32446Usart2_fe(void)
{
	return get_reg_block(USART2->SR, 1, 1);
}
uint8_t STM32446Usart2_pe(void)
{
	return get_reg_block(USART2->SR, 1, 0);
}
// DR
void STM32446Usart2_dr(uint32_t data)
{
	write_reg_block(&USART2->DR, 9, 0, data);
}
uint32_t STM32446Usart2_get_dr(void)
{
	return get_reg_block(USART2->DR, 9, 0);
}
// BRR
void STM32446Usart2_div_mantissa(uint16_t value)
{
	set_reg_block(&USART2->BRR, 12, 4, value);
}
void STM32446Usart2_div_fraction(uint8_t value)
{
	set_reg_block(&USART2->BRR, 4, 0, value);
}
// CR1
void STM32446Usart2_over8(uint8_t state)
{
	set_reg_block(&USART2->CR1, 1, 15, state);
}
void STM32446Usart2_ue(uint8_t state)
{
	set_reg_block(&USART2->CR1, 1, 13, state);
}
void STM32446Usart2_m(uint8_t state)
{
	set_reg_block(&USART2->CR1, 1, 12, state);
}
void STM32446Usart2_wake(uint8_t state)
{
	set_reg_block(&USART2->CR1, 1, 11, state);
}
void STM32446Usart2_pce(uint8_t state)
{
	set_reg_block(&USART2->CR1, 1, 10, state);
}
void STM32446Usart2_ps(uint8_t state)
{
	set_reg_block(&USART2->CR1, 1, 9, state);
}
void STM32446Usart2_peie(uint8_t state)
{
	set_reg_block(&USART2->CR1, 1, 8, state);
}
void STM32446Usart2_txeie(uint8_t state)
{
	set_reg_block(&USART2->CR1, 1, 7, state);
}
void STM32446Usart2_tcie(uint8_t state)
{
	set_reg_block(&USART2->CR1, 1, 6, state);
}
void STM32446Usart2_rxneie(uint8_t state)
{
	set_reg_block(&USART2->CR1, 1, 5, state);
}
void STM32446Usart2_idleie(uint8_t state)
{
	set_reg_block(&USART2->CR1, 1, 4, state);
}
void STM32446Usart2_te(uint8_t state)
{
	set_reg_block(&USART2->CR1, 1, 3, state);
}
void STM32446Usart2_re(uint8_t state)
{
	set_reg_block(&USART2->CR1, 1, 2, state);
}
void STM32446Usart2_rwu(uint8_t state)
{
	set_reg_block(&USART2->CR1, 1, 1, state);
}
void STM32446Usart2_sbk(uint8_t state)
{
	set_reg_block(&USART2->CR1, 1, 0, state);
}
// CR2
void STM32446Usart2_linen(uint8_t state)
{
	set_reg_block(&USART2->CR2, 1, 14, state);
}
void STM32446Usart2_stop(uint8_t value)
{
	set_reg_block(&USART2->CR2, 2, 12, value);
}
void STM32446Usart2_clken(uint8_t state)
{
	set_reg_block(&USART2->CR2, 1, 11, state);
}
void STM32446Usart2_cpol(uint8_t state)
{
	set_reg_block(&USART2->CR2, 1, 10, state);
}
void STM32446Usart2_cpha(uint8_t state)
{
	set_reg_block(&USART2->CR2, 1, 9, state);
}
void STM32446Usart2_lbcl(uint8_t state)
{
	set_reg_block(&USART2->CR2, 1, 8, state);
}
void STM32446Usart2_lbdie(uint8_t state)
{
	set_reg_block(&USART2->CR2, 1, 6, state);
}
void STM32446Usart2_lbdl(uint8_t state)
{
	set_reg_block(&USART2->CR2, 1, 5, state);
}
void STM32446Usart2_add(uint8_t value)
{
	set_reg_block(&USART2->CR2, 4, 0, value);
}
// CR3
void STM32446Usart2_onebit(uint8_t state)
{
	set_reg_block(&USART2->CR3, 1, 11, state);
}
void STM32446Usart2_ctsie(uint8_t state)
{
	set_reg_block(&USART2->CR3, 1, 10, state);
}
void STM32446Usart2_ctse(uint8_t state)
{
	set_reg_block(&USART2->CR3, 1, 9, state);
}
void STM32446Usart2_rtse(uint8_t state)
{
	set_reg_block(&USART2->CR3, 1, 8, state);
}
void STM32446Usart2_dmat(uint8_t state)
{
	set_reg_block(&USART2->CR3, 1, 7, state);
}
void STM32446Usart2_dmar(uint8_t state)
{
	set_reg_block(&USART2->CR3, 1, 6, state);
}
void STM32446Usart2_scen(uint8_t state)
{
	set_reg_block(&USART2->CR3, 1, 5, state);
}
void STM32446Usart2_nack(uint8_t state)
{
	set_reg_block(&USART2->CR3, 1, 4, state);
}
void STM32446Usart2_hdsel(uint8_t state)
{
	set_reg_block(&USART2->CR3, 1, 3, state);
}
void STM32446Usart2_irlp(uint8_t state)
{
	set_reg_block(&USART2->CR3, 1, 2, state);
}
void STM32446Usart2_iren(uint8_t state)
{
	set_reg_block(&USART2->CR3, 1, 1, state);
}
void STM32446Usart2_eie(uint8_t state)
{
	set_reg_block(&USART2->CR3, 1, 0, state);
}
// GTPR
void STM32446Usart2_gt(uint8_t value)
{
	set_reg_block(&USART2->GTPR, 8, 8, value);
}
void STM32446Usart2_psc(uint8_t value)
{
	set_reg_block(&USART2->GTPR, 8, 0, value);
}
/*** USART3 ***/
void STM32446Usart3Clock( uint8_t state )
{
	if(state){ RCC->APB1ENR |= (1 << 18); }else{ RCC->APB1ENR &= ~(1 << 18); }
}
void STM32446Usart3Nvic( uint8_t state )
{
...
{
	return get_reg_block(USART3->SR, 1, 9);
}
void STM32446Usart3_clear_cts(void)
{
	set_reg_block(&USART3->SR, 1, 9, 0);
}
uint8_t STM32446Usart3_lbd(void)
{
	return get_reg_block(USART3->SR, 1, 8);
}
void STM32446Usart3_clear_lbd(void)
{
	set_reg_block(&USART3->SR, 1, 8, 0);
}
uint8_t STM32446Usart3_txe(void)
{
	return get_reg_block(USART3->SR, 1, 7);
}
uint8_t STM32446Usart3_tc(void)
{
	return get_reg_block(USART3->SR, 1, 6);
}
void STM32446Usart3_clear_tc(void)
{
	set_reg_block(&USART3->SR, 1, 6, 0);
}
uint8_t STM32446Usart3_rxne(void)
{
	return get_reg_block(USART3->SR, 1, 5);
}
void STM32446Usart3_clear_rxne(void)
{
	set_reg_block(&USART3->SR, 1, 5, 0);
}
uint8_t STM32446Usart3_idle(void)
{
	return get_reg_block(USART3->SR, 1, 4);
}
uint8_t STM32446Usart3_ore(void)
{
	return get_reg_block(USART3->SR, 1, 3);
}
uint8_t STM32446Usart3_nf(void)
{
	return get_reg_block(USART3->SR, 1, 2);
}
uint8_t STM32446Usart3_fe(void)
{
	return get_reg_block(USART3->SR, 1, 1);
}
uint8_t STM32446Usart3_pe(void)
{
	return get_reg_block(USART3->SR, 1, 0);
}
// DR
void STM32446Usart3_dr(uint32_t data)
{
	write_reg_block(&USART3->DR, 9, 0, data);
}
uint32_t STM32446Usart3_get_dr(void)
{
	return get_reg_block(USART3->DR, 9, 0);
}
// BRR
void STM32446Usart3_div_mantissa(uint16_t value)
{
	set_reg_block(&USART3->BRR, 12, 4, value);
}
void STM32446Usart3_div_fraction(uint8_t value)
{
	set_reg_block(&USART3->BRR, 4, 0, value);
}
// CR1
void STM32446Usart3_over8(uint8_t state)
{
	set_reg_block(&USART3->CR1, 1, 15, state);
}
void STM32446Usart3_ue(uint8_t state)
{
	set_reg_block(&USART3->CR1, 1, 13, state);
}
void STM32446Usart3_m(uint8_t state)
{
	set_reg_block(&USART3->CR1, 1, 12, state);
}
void STM32446Usart3_wake(uint8_t state)
{
	set_reg_block(&USART3->CR1, 1, 11, state);
}
void STM32446Usart3_pce(uint8_t state)
{
	set_reg_block(&USART3->CR1, 1, 10, state);
}
void STM32446Usart3_ps(uint8_t state)
{
	set_reg_block(&USART3->CR1, 1, 9, state);
}
void STM32446Usart3_peie(uint8_t state)
{
	set_reg_block(&USART3->CR1, 1, 8, state);
}
void STM32446Usart3_txeie(uint8_t state)
{
	set_reg_block(&USART3->CR1, 1, 7, state);
}
void STM32446Usart3_tcie(uint8_t state)
{
	set_reg_block(&USART3->CR1, 1, 6, state);
}
void STM32446Usart3_rxneie(uint8_t state)
{
	set_reg_block(&USART3->CR1, 1, 5, state);
}
void STM32446Usart3_idleie(uint8_t state)
{
	set_reg_block(&USART3->CR1, 1, 4, state);
}
void STM32446Usart3_te(uint8_t state)
{
	set_reg_block(&USART3->CR1, 1, 3, state);
}
void STM32446Usart3_re(uint8_t state)
{
	set_reg_block(&USART3->CR1, 1, 2, state);
}
void STM32446Usart3_rwu(uint8_t state)
{
	set_reg_block(&USART3->CR1, 1, 1, state);
}
void STM32446Usart3_sbk(uint8_t state)
{
	set_reg_block(&USART3->CR1, 1, 0, state);
}
// CR2
void STM32446Usart3_linen(uint8_t state)
{
	set_reg_block(&USART3->CR2, 1, 14, state);
}
void STM32446Usart3_stop(uint8_t value)
{
	set_reg_block(&USART3->CR2, 2, 12, value);
}
void STM32446Usart3_clken(uint8_t state)
{
	set_reg_block(&USART3->CR2, 1, 11, state);
}
void STM32446Usart3_cpol(uint8_t state)
{
	set_reg_block(&USART3->CR2, 1, 10, state);
}
void STM32446Usart3_cpha(uint8_t state)
{
	set_reg_block(&USART3->CR2, 1, 9, state);
}
void STM32446Usart3_lbcl(uint8_t state)
{
	set_reg_block(&USART3->CR2, 1, 8, state);
}
void STM32446Usart3_lbdie(uint8_t state)
{
	set_reg_block(&USART3->CR2, 1, 6, state);
}
void STM32446Usart3_lbdl(uint8_t state)
{
	set_reg_block(&USART3->CR2, 1, 5, state);
}
void STM32446Usart3_add(uint8_t value)
{
	set_reg_block(&USART3->CR2, 4, 0, value);
}
// CR3
void STM32446Usart3_onebit(uint8_t state)
{
	set_reg_block(&USART3->CR3, 1, 11, state);
}
void STM32446Usart3_ctsie(uint8_t state)
{
	set_reg_block(&USART3->CR3, 1, 10, state);
}
void STM32446Usart3_ctse(uint8_t state)
{
	set_reg_block(&USART3->CR3, 1, 9, state);
}
void STM32446Usart3_rtse(uint8_t state)
{
	set_reg_block(&USART3->CR3, 1, 8, state);
}
void STM32446Usart3_dmat(uint8_t state)
{
	set_reg_block(&USART3->CR3, 1, 7, state);
}
void STM32446Usart3_dmar(uint8_t state)
{
	set_reg_block(&USART3->CR3, 1, 6, state);
}
void STM32446Usart3_scen(uint8_t state)
{
	set_reg_block(&USART3->CR3, 1, 5, state);
}
void STM32446Usart3_nack(uint8_t state)
{
	set_reg_block(&USART3->CR3, 1, 4, state);
}
void STM32446Usart3_hdsel(uint8_t state)
{
	set_reg_block(&USART3->CR3, 1, 3, state);
}
void STM32446Usart3_irlp(uint8_t state)
{
	set_reg_block(&USART3->CR3, 1, 2, state);
}
void STM32446Usart3_iren(uint8_t state)
{
	set_reg_block(&USART3->CR3, 1, 1, state);
}
void STM32446Usart3_eie(uint8_t state)
{
	set_reg_block(&USART3->CR3, 1, 0, state);
}
// GTPR
void STM32446Usart3_gt(uint8_t value)
{
	set_reg_block(&USART3->GTPR, 8, 8, value);
}
void STM32446Usart3_psc(uint8_t value)
{
	set_reg_block(&USART3->GTPR, 8, 0, value);
}
/*** UART4 ***/
void STM32446Uart4Clock( uint8_t state )
{
	if(state){ RCC->APB1ENR |= (1 << 19); }else{ RCC->APB1ENR &= ~(1 << 19); }

}
void STM32446Uart4Nvic( uint8_t state )
{
...
{
	return get_reg_block(UART4->SR, 1, 9);
}
void STM32446Uart4_clear_cts(void)
{
	set_reg_block(&UART4->SR, 1, 9, 0);
}
uint8_t STM32446Uart4_lbd(void)
{
	return get_reg_block(UART4->SR, 1, 8);
}
void STM32446Uart4_clear_lbd(void)
{
	set_reg_block(&UART4->SR, 1, 8, 0);
}
uint8_t STM32446Uart4_txe(void)
{
	return get_reg_block(UART4->SR, 1, 7);
}
uint8_t STM32446Uart4_tc(void)
{
	return get_reg_block(UART4->SR, 1, 6);
}
void STM32446Uart4_clear_tc(void)
{
	set_reg_block(&UART4->SR, 1, 6, 0);
}
uint8_t STM32446Uart4_rxne(void)
{
	return get_reg_block(UART4->SR, 1, 5);
}
void STM32446Uart4_clear_rxne(void)
{
	set_reg_block(&UART4->SR, 1, 5, 0);
}
uint8_t STM32446Uart4_idle(void)
{
	return get_reg_block(UART4->SR, 1, 4);
}
uint8_t STM32446Uart4_ore(void)
{
	return get_reg_block(UART4->SR, 1, 3);
}
uint8_t STM32446Uart4_nf(void)
{
	return get_reg_block(UART4->SR, 1, 2);
}
uint8_t STM32446Uart4_fe(void)
{
	return get_reg_block(UART4->SR, 1, 1);
}
uint8_t STM32446Uart4_pe(void)
{
	return get_reg_block(UART4->SR, 1, 0);
}
// DR
void STM32446Uart4_dr(uint32_t data)
{
	write_reg_block(&UART4->DR, 9, 0, data);
}
uint32_t STM32446Uart4_get_dr(void)
{
	return get_reg_block(UART4->DR, 9, 0);
}
// BRR
void STM32446Uart4_div_mantissa(uint16_t value)
{
	set_reg_block(&UART4->BRR, 12, 4, value);
}
void STM32446Uart4_div_fraction(uint8_t value)
{
	set_reg_block(&UART4->BRR, 4, 0, value);
}
// CR1
void STM32446Uart4_over8(uint8_t state)
{
	set_reg_block(&UART4->CR1, 1, 15, state);
}
void STM32446Uart4_ue(uint8_t state)
{
	set_reg_block(&UART4->CR1, 1, 13, state);
}
void STM32446Uart4_m(uint8_t state)
{
	set_reg_block(&UART4->CR1, 1, 12, state);
}
void STM32446Uart4_wake(uint8_t state)
{
	set_reg_block(&UART4->CR1, 1, 11, state);
}
void STM32446Uart4_pce(uint8_t state)
{
	set_reg_block(&UART4->CR1, 1, 10, state);
}
void STM32446Uart4_ps(uint8_t state)
{
	set_reg_block(&UART4->CR1, 1, 9, state);
}
void STM32446Uart4_peie(uint8_t state)
{
	set_reg_block(&UART4->CR1, 1, 8, state);
}
void STM32446Uart4_txeie(uint8_t state)
{
	set_reg_block(&UART4->CR1, 1, 7, state);
}
void STM32446Uart4_tcie(uint8_t state)
{
	set_reg_block(&UART4->CR1, 1, 6, state);
}
void STM32446Uart4_rxneie(uint8_t state)
{
	set_reg_block(&UART4->CR1, 1, 5, state);
}
void STM32446Uart4_idleie(uint8_t state)
{
	set_reg_block(&UART4->CR1, 1, 4, state);
}
void STM32446Uart4_te(uint8_t state)
{
	set_reg_block(&UART4->CR1, 1, 3, state);
}
void STM32446Uart4_re(uint8_t state)
{
	set_reg_block(&UART4->CR1, 1, 2, state);
}
void STM32446Uart4_rwu(uint8_t state)
{
	set_reg_block(&UART4->CR1, 1, 1, state);
}
void STM32446Uart4_sbk(uint8_t state)
{
	set_reg_block(&UART4->CR1, 1, 0, state);
}
// CR2
void STM32446Uart4_linen(uint8_t state)
{
	set_reg_block(&UART4->CR2, 1, 14, state);
}
void STM32446Uart4_stop(uint8_t value)
{
	set_reg_block(&UART4->CR2, 2, 12, value);
}
void STM32446Uart4_clken(uint8_t state)
{
	set_reg_block(&UART4->CR2, 1, 11, state);
}
void STM32446Uart4_cpol(uint8_t state)
{
	set_reg_block(&UART4->CR2, 1, 10, state);
}
void STM32446Uart4_cpha(uint8_t state)
{
	set_reg_block(&UART4->CR2, 1, 9, state);
}
void STM32446Uart4_lbcl(uint8_t state)
{
	set_reg_block(&UART4->CR2, 1, 8, state);
}
void STM32446Uart4_lbdie(uint8_t state)
{
	set_reg_block(&UART4->CR2, 1, 6, state);
}
void STM32446Uart4_lbdl(uint8_t state)
{
	set_reg_block(&UART4->CR2, 1, 5, state);
}
void STM32446Uart4_add(uint8_t value)
{
	set_reg_block(&UART4->CR2, 4, 0, value);
}
// CR3
void STM32446Uart4_onebit(uint8_t state)
{
	set_reg_block(&UART4->CR3, 1, 11, state);
}
void STM32446Uart4_ctsie(uint8_t state)
{
	set_reg_block(&UART4->CR3, 1, 10, state);
}
void STM32446Uart4_ctse(uint8_t state)
{
	set_reg_block(&UART4->CR3, 1, 9, state);
}
void STM32446Uart4_rtse(uint8_t state)
{
	set_reg_block(&UART4->CR3, 1, 8, state);
}
void STM32446Uart4_dmat(uint8_t state)
{
	set_reg_block(&UART4->CR3, 1, 7, state);
}
void STM32446Uart4_dmar(uint8_t state)
{
	set_reg_block(&UART4->CR3, 1, 6, state);
}
void STM32446Uart4_scen(uint8_t state)
{
	set_reg_block(&UART4->CR3, 1, 5, state);
}
void STM32446Uart4_nack(uint8_t state)
{
	set_reg_block(&UART4->CR3, 1, 4, state);
}
void STM32446Uart4_hdsel(uint8_t state)
{
	set_reg_block(&UART4->CR3, 1, 3, state);
}
void STM32446Uart4_irlp(uint8_t state)
{
	set_reg_block(&UART4->CR3, 1, 2, state);
}
void STM32446Uart4_iren(uint8_t state)
{
	set_reg_block(&UART4->CR3, 1, 1, state);
}
void STM32446Uart4_eie(uint8_t state)
{
	set_reg_block(&UART4->CR3, 1, 0, state);
}
// GTPR
void STM32446Uart4_gt(uint8_t value)
{
	set_reg_block(&UART4->GTPR, 8, 8, value);
}
void STM32446Uart4_psc(uint8_t value)
{
	set_reg_block(&UART4->GTPR, 8, 0, value);
}
/*** UART5 ***/
void STM32446Uart5Clock( uint8_t state )
{
	if(state){ RCC->APB1ENR |= (1 << 20); } // UART5EN: USART5 clock enable
	else{ RCC->APB1ENR &= ~(1 << 20); } // UART5EN: USART5 clock disable
}
void STM32446Uart5Nvic( uint8_t state )
{
...
{
	return get_reg_block(UART5->SR, 1, 9);
}
void STM32446Uart5_clear_cts(void)
{
	set_reg_block(&UART5->SR, 1, 9, 0);
}
uint8_t STM32446Uart5_lbd(void)
{
	return get_reg_block(UART5->SR, 1, 8);
}
void STM32446Uart5_clear_lbd(void)
{
	set_reg_block(&UART5->SR, 1, 8, 0);
}
uint8_t STM32446Uart5_txe(void)
{
	return get_reg_block(UART5->SR, 1, 7);
}
uint8_t STM32446Uart5_tc(void)
{
	return get_reg_block(UART5->SR, 1, 6);
}
void STM32446Uart5_clear_tc(void)
{
	set_reg_block(&UART5->SR, 1, 6, 0);
}
uint8_t STM32446Uart5_rxne(void)
{
	return get_reg_block(UART5->SR, 1, 5);
}
void STM32446Uart5_clear_rxne(void)
{
	set_reg_block(&UART5->SR, 1, 5, 0);
}
uint8_t STM32446Uart5_idle(void)
{
	return get_reg_block(UART5->SR, 1, 4);
}
uint8_t STM32446Uart5_ore(void)
{
	return get_reg_block(UART5->SR, 1, 3);
}
uint8_t STM32446Uart5_nf(void)
{
	return get_reg_block(UART5->SR, 1, 2);
}
uint8_t STM32446Uart5_fe(void)
{
	return get_reg_block(UART5->SR, 1, 1);
}
uint8_t STM32446Uart5_pe(void)
{
	return get_reg_block(UART5->SR, 1, 0);
}
// DR
void STM32446Uart5_dr(uint32_t data)
{
	write_reg_block(&UART5->DR, 9, 0, data);
}
uint32_t STM32446Uart5_get_dr(void)
{
	return get_reg_block(UART5->DR, 9, 0);
}
// BRR
void STM32446Uart5_div_mantissa(uint16_t value)
{
	set_reg_block(&UART5->BRR, 12, 4, value);
}
void STM32446Uart5_div_fraction(uint8_t value)
{
	set_reg_block(&UART5->BRR, 4, 0, value);
}
// CR1
void STM32446Uart5_over8(uint8_t state)
{
	set_reg_block(&UART5->CR1, 1, 15, state);
}
void STM32446Uart5_ue(uint8_t state)
{
	set_reg_block(&UART5->CR1, 1, 13, state);
}
void STM32446Uart5_m(uint8_t state)
{
	set_reg_block(&UART5->CR1, 1, 12, state);
}
void STM32446Uart5_wake(uint8_t state)
{
	set_reg_block(&UART5->CR1, 1, 11, state);
}
void STM32446Uart5_pce(uint8_t state)
{
	set_reg_block(&UART5->CR1, 1, 10, state);
}
void STM32446Uart5_ps(uint8_t state)
{
	set_reg_block(&UART5->CR1, 1, 9, state);
}
void STM32446Uart5_peie(uint8_t state)
{
	set_reg_block(&UART5->CR1, 1, 8, state);
}
void STM32446Uart5_txeie(uint8_t state)
{
	set_reg_block(&UART5->CR1, 1, 7, state);
}
void STM32446Uart5_tcie(uint8_t state)
{
	set_reg_block(&UART5->CR1, 1, 6, state);
}
void STM32446Uart5_rxneie(uint8_t state)
{
	set_reg_block(&UART5->CR1, 1, 5, state);
}
void STM32446Uart5_idleie(uint8_t state)
{
	set_reg_block(&UART5->CR1, 1, 4, state);
}
void STM32446Uart5_te(uint8_t state)
{
	set_reg_block(&UART5->CR1, 1, 3, state);
}
void STM32446Uart5_re(uint8_t state)
{
	set_reg_block(&UART5->CR1, 1, 2, state);
}
void STM32446Uart5_rwu(uint8_t state)
{
	set_reg_block(&UART5->CR1, 1, 1, state);
}
void STM32446Uart5_sbk(uint8_t state)
{
	set_reg_block(&UART5->CR1, 1, 0, state);
}
// CR2
void STM32446Uart5_linen(uint8_t state)
{
	set_reg_block(&UART5->CR2, 1, 14, state);
}
void STM32446Uart5_stop(uint8_t value)
{
	set_reg_block(&UART5->CR2, 2, 12, value);
}
void STM32446Uart5_clken(uint8_t state)
{
	set_reg_block(&UART5->CR2, 1, 11, state);
}
void STM32446Uart5_cpol(uint8_t state)
{
	set_reg_block(&UART5->CR2, 1, 10, state);
}
void STM32446Uart5_cpha(uint8_t state)
{
	set_reg_block(&UART5->CR2, 1, 9, state);
}
void STM32446Uart5_lbcl(uint8_t state)
{
	set_reg_block(&UART5->CR2, 1, 8, state);
}
void STM32446Uart5_lbdie(uint8_t state)
{
	set_reg_block(&UART5->CR2, 1, 6, state);
}
void STM32446Uart5_lbdl(uint8_t state)
{
	set_reg_block(&UART5->CR2, 1, 5, state);
}
void STM32446Uart5_add(uint8_t value)
{
	set_reg_block(&UART5->CR2, 4, 0, value);
}
// CR3
void STM32446Uart5_onebit(uint8_t state)
{
	set_reg_block(&UART5->CR3, 1, 11, state);
}
void STM32446Uart5_ctsie(uint8_t state)
{
	set_reg_block(&UART5->CR3, 1, 10, state);
}
void STM32446Uart5_ctse(uint8_t state)
{
	set_reg_block(&UART5->CR3, 1, 9, state);
}
void STM32446Uart5_rtse(uint8_t state)
{
	set_reg_block(&UART5->CR3, 1, 8, state);
}
void STM32446Uart5_dmat(uint8_t state)
{
	set_reg_block(&UART5->CR3, 1, 7, state);
}
void STM32446Uart5_dmar(uint8_t state)
{
	set_reg_block(&UART5->CR3, 1, 6, state);
}
void STM32446Uart5_scen(uint8_t state)
{
	set_reg_block(&UART5->CR3, 1, 5, state);
}
void STM32446Uart5_nack(uint8_t state)
{
	set_reg_block(&UART5->CR3, 1, 4, state);
}
void STM32446Uart5_hdsel(uint8_t state)
{
	set_reg_block(&UART5->CR3, 1, 3, state);
}
void STM32446Uart5_irlp(uint8_t state)
{
	set_reg_block(&UART5->CR3, 1, 2, state);
}
void STM32446Uart5_iren(uint8_t state)
{
	set_reg_block(&UART5->CR3, 1, 1, state);
}
void STM32446Uart5_eie(uint8_t state)
{
	set_reg_block(&UART5->CR3, 1, 0, state);
}
// GTPR
void STM32446Uart5_gt(uint8_t value)
{
	set_reg_block(&UART5->GTPR, 8, 8, value);
}
void STM32446Uart5_psc(uint8_t value)
{
	set_reg_block(&UART5->GTPR, 8, 0, value);
}
/*** USART6 ***/
void STM32446Usart6Clock( uint8_t state )
{
	if(state){ RCC->APB2ENR |= (1 << 5); }else{ RCC->APB2ENR &= ~(1 << 5); }
}
void STM32446Usart6Nvic( uint8_t state )
{
...
{
	return get_reg_block(USART6->SR, 1, 9);
}
void STM32446Usart6_clear_cts(void)
{
	set_reg_block(&USART6->SR, 1, 9, 0);
}
uint8_t STM32446Usart6_lbd(void)
{
	return get_reg_block(USART6->SR, 1, 8);
}
void STM32446Usart6_clear_lbd(void)
{
	set_reg_block(&USART6->SR, 1, 8, 0);
}
uint8_t STM32446Usart6_txe(void)
{
	return get_reg_block(USART6->SR, 1, 7);
}
uint8_t STM32446Usart6_tc(void)
{
	return get_reg_block(USART6->SR, 1, 6);
}
void STM32446Usart6_clear_tc(void)
{
	set_reg_block(&USART6->SR, 1, 6, 0);
}
uint8_t STM32446Usart6_rxne(void)
{
	return get_reg_block(USART6->SR, 1, 5);
}
void STM32446Usart6_clear_rxne(void)
{
	set_reg_block(&USART6->SR, 1, 5, 0);
}
uint8_t STM32446Usart6_idle(void)
{
	return get_reg_block(USART6->SR, 1, 4);
}
uint8_t STM32446Usart6_ore(void)
{
	return get_reg_block(USART6->SR, 1, 3);
}
uint8_t STM32446Usart6_nf(void)
{
	return get_reg_block(USART6->SR, 1, 2);
}
uint8_t STM32446Usart6_fe(void)
{
	return get_reg_block(USART6->SR, 1, 1);
}
uint8_t STM32446Usart6_pe(void)
{
	return get_reg_block(USART6->SR, 1, 0);
}
// DR
void STM32446Usart6_dr(uint32_t data)
{
	write_reg_block(&USART6->DR, 9, 0, data);
}
uint32_t STM32446Usart6_get_dr(void)
{
	return get_reg_block(USART6->DR, 9, 0);
}
// BRR
void STM32446Usart6_div_mantissa(uint16_t value)
{
	set_reg_block(&USART6->BRR, 12, 4, value);
}
void STM32446Usart6_div_fraction(uint8_t value)
{
	set_reg_block(&USART6->BRR, 4, 0, value);
}
// CR1
void STM32446Usart6_over8(uint8_t state)
{
	set_reg_block(&USART6->CR1, 1, 15, state);
}
void STM32446Usart6_ue(uint8_t state)
{
	set_reg_block(&USART6->CR1, 1, 13, state);
}
void STM32446Usart6_m(uint8_t state)
{
	set_reg_block(&USART6->CR1, 1, 12, state);
}
void STM32446Usart6_wake(uint8_t state)
{
	set_reg_block(&USART6->CR1, 1, 11, state);
}
void STM32446Usart6_pce(uint8_t state)
{
	set_reg_block(&USART6->CR1, 1, 10, state);
}
void STM32446Usart6_ps(uint8_t state)
{
	set_reg_block(&USART6->CR1, 1, 9, state);
}
void STM32446Usart6_peie(uint8_t state)
{
	set_reg_block(&USART6->CR1, 1, 8, state);
}
void STM32446Usart6_txeie(uint8_t state)
{
	set_reg_block(&USART6->CR1, 1, 7, state);
}
void STM32446Usart6_tcie(uint8_t state)
{
	set_reg_block(&USART6->CR1, 1, 6, state);
}
void STM32446Usart6_rxneie(uint8_t state)
{
	set_reg_block(&USART6->CR1, 1, 5, state);
}
void STM32446Usart6_idleie(uint8_t state)
{
	set_reg_block(&USART6->CR1, 1, 4, state);
}
void STM32446Usart6_te(uint8_t state)
{
	set_reg_block(&USART6->CR1, 1, 3, state);
}
void STM32446Usart6_re(uint8_t state)
{
	set_reg_block(&USART6->CR1, 1, 2, state);
}
void STM32446Usart6_rwu(uint8_t state)
{
	set_reg_block(&USART6->CR1, 1, 1, state);
}
void STM32446Usart6_sbk(uint8_t state)
{
	set_reg_block(&USART6->CR1, 1, 0, state);
}
// CR2
void STM32446Usart6_linen(uint8_t state)
{
	set_reg_block(&USART6->CR2, 1, 14, state);
}
void STM32446Usart6_stop(uint8_t value)
{
	set_reg_block(&USART6->CR2, 2, 12, value);
}
void STM32446Usart6_clken(uint8_t state)
{
	set_reg_block(&USART6->CR2, 1, 11, state);
}
void STM32446Usart6_cpol(uint8_t state)
{
	set_reg_block(&USART6->CR2, 1, 10, state);
}
void STM32446Usart6_cpha(uint8_t state)
{
	set_reg_block(&USART6->CR2, 1, 9, state);
}
void STM32446Usart6_lbcl(uint8_t state)
{
	set_reg_block(&USART6->CR2, 1, 8, state);
}
void STM32446Usart6_lbdie(uint8_t state)
{
	set_reg_block(&USART6->CR2, 1, 6, state);
}
void STM32446Usart6_lbdl(uint8_t state)
{
	set_reg_block(&USART6->CR2, 1, 5, state);
}
void STM32446Usart6_add(uint8_t value)
{
	set_reg_block(&USART6->CR2, 4, 0, value);
}
// CR3
void STM32446Usart6_onebit(uint8_t state)
{
	set_reg_block(&USART6->CR3, 1, 11, state);
}
void STM32446Usart6_ctsie(uint8_t state)
{
	set_reg_block(&USART6->CR3, 1, 10, state);
}
void STM32446Usart6_ctse(uint8_t state)
{
	set_reg_block(&USART6->CR3, 1, 9, state);
}
void STM32446Usart6_rtse(uint8_t state)
{
	set_reg_block(&USART6->CR3, 1, 8, state);
}
void STM32446Usart6_dmat(uint8_t state)
{
	set_reg_block(&USART6->CR3, 1, 7, state);
}
void STM32446Usart6_dmar(uint8_t state)
{
	set_reg_block(&USART6->CR3, 1, 6, state);
}
void STM32446Usart6_scen(uint8_t state)
{
	set_reg_block(&USART6->CR3, 1, 5, state);
}
void STM32446Usart6_nack(uint8_t state)
{
	set_reg_block(&USART6->CR3, 1, 4, state);
}
void STM32446Usart6_hdsel(uint8_t state)
{
	set_reg_block(&USART6->CR3, 1, 3, state);
}
void STM32446Usart6_irlp(uint8_t state)
{
	set_reg_block(&USART6->CR3, 1, 2, state);
}
void STM32446Usart6_iren(uint8_t state)
{
	set_reg_block(&USART6->CR3, 1, 1, state);
}
void STM32446Usart6_eie(uint8_t state)
{
	set_reg_block(&USART6->CR3, 1, 0, state);
}
// GTPR
void STM32446Usart6_gt(uint8_t value)
{
	set_reg_block(&USART6->GTPR, 8, 8, value);
}
void STM32446Usart6_psc(uint8_t value)
{
	set_reg_block(&USART6->GTPR, 8, 0, value);
}
/*** USART1 Auxiliar ***/
STM32446USART_SR* stm32446_usart1_sr_inic(void)
{
