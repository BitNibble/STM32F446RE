...
/***/
void STM32446PwrClock(uint8_t state);
void STM32446BckSramClock(uint8_t state);
...
void STM32446RtcClock(uint8_t state)
{
	STM32446RtcWriteEnable();
	if(state){ RCC->BDCR |= (1 <<  15); }else{ RCC->BDCR &= ~(1 <<  15); }
